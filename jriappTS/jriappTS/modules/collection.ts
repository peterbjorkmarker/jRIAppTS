module RIAPP {
    export module MOD {
        export module collection {
           ...
           export interface ICollItemAddedArgs { item: CollectionItem; isAddNewHandled: boolean; }
           ...
           export class Collection extends RIAPP.BaseObject {
                ...
                addOnItemDeleting(fn: (sender: Collection, args: { item: CollectionItem; isCancel:boolean; }) => void , namespace?: string) {
                ...
                addOnItemAdding(fn: (sender: Collection, args: { item: CollectionItem; isCancel: boolean; }) => void , namespace?: string) {
                    this.addHandler('item_adding', fn, namespace);
                }
                removeOnItemAdding(namespace?: string) {
                    this.removeHandler('item_adding', namespace);
                }
                addOnItemAdded(fn: (sender: Collection, args: { item: CollectionItem; isAddNewHandled: boolean; }) => void , namespace?: string) {
                ...
                addOnPageChanging(fn: (sender: Collection, args: { page: number; isCancel: boolean; }) => void , namespace?: string) {
                ...
                addOnEndEdit(fn: (sender: Collection, args: { item: CollectionItem; isCanceled: boolean; }) => void , namespace?: string) {
                    this.addHandler('end_edit', fn, namespace);
                }
                removeOnEndEdit(namespace?: string) {
                    this.removeHandler('end_edit', namespace);
                }
                addOnCommitChanges(fn: (sender: Collection, args: { item: CollectionItem; isBegin: boolean; isRejected: boolean; changeType: number; }) => void , namespace?: string) {
                ...
                _onEditing(item: CollectionItem, isBegin:boolean, isCanceled:boolean) {
                    if (this._isUpdating)
                        return;
                    if (isBegin) {
                ...
                _onCommitChanges(item: CollectionItem, isBegin: boolean, isRejected: boolean, changeType: number) {
                ...
                _onFillEnd(args: { isBegin: boolean; rowCount: number; time: Date; isPageChanged: boolean; resetUI: boolean; fetchedItems: CollectionItem[]; newItems: CollectionItem[]; }) {
                    this.raiseEvent('fill', args);
                }
                ...
                addNew() {
                    var item: CollectionItem, isHandled:boolean;
           ...
           export class List extends Collection {
                ...
                fillItems(objArray:any[], clearAll?:boolean) {
