    ...
    export module MOD {
        export module collection {
            ...
            export class ItemAspect<TItem extends ICollectionItem> extends RIAPP.BaseObject implements IErrorNotification, RIAPP.IEditable, RIAPP.ISubmittable {
                ...
                get isCanSubmit() { return false; }
                get status() { return this._status; }
                get isNew() {
                    return false;
                }
                get isDeleted() { return false; }
                get _key() { return this.__key; }
                set _key(v) {
                    if (v !== null)
                        v = '' + v;
                    this.__key = v;
                }
                get collection(): BaseCollection<ICollectionItem> { return null; }
                get isUpdating() {
                    var coll = this.collection;
                    if (!coll)
                        return false;
                ...
                get isEditing() { return this.__isEditing; }
            }
            ...
            export class BaseCollection<TItem extends ICollectionItem> extends RIAPP.BaseObject {
                ...
                protected _attach(item: TItem, itemPos?: number) {
                    ...
                    this._onItemsChanged({ changeType: COLL_CHANGE_TYPE.ADDED, items: [item], pos: [pos] });
                ...
                protected _onRemoved(item: TItem, pos: number) {
                    try {
                        this._onItemsChanged({ changeType: COLL_CHANGE_TYPE.REMOVE, items: [item], pos: [pos] });
                    }
                    finally {
                        this.raisePropertyChanged(PROP_NAME.count);
                    }
                ...
                _onCommitChanges(item: TItem, isBegin: boolean, isRejected: boolean, status: STATUS) {
                ...
                sortLocalByFunc(fn: (a, b) => number): IPromise<any> {
                    ...
                    this.waitForNotLoading(function () {
                        ...
                        try {
                            self._items.sort(fn);
                            self._onItemsChanged({ changeType: COLL_CHANGE_TYPE.RESET, items: [], pos: [] });
                        } finally {
                ...
                clear() {
                    ...
                    try {
                        ...
                        this._itemsByKey = {};
                        this._errors = {};
                        this._onItemsChanged({ changeType: COLL_CHANGE_TYPE.RESET, items: [], pos: [] });
                    }
                    finally {
                        this._isClearing = false;
                    }
            ...
            export class ListItemAspect<TItem extends IListItem, TObj> extends ItemAspect<TItem> {
                ...
                get collection() { return this.__coll; }
            }
                ...
                fillItems(objArray: TObj[], clearAll?: boolean) {
                    ...
                    try {
                        ...
                        if (newItems.length > 0) {
                            this._onItemsChanged({ changeType: COLL_CHANGE_TYPE.ADDED, items: newItems, pos: positions });
                            this.raisePropertyChanged(PROP_NAME.count);
                        }
                    }
                    finally {
