...
(function (RIAPP) {
            ...
            var DataGrid = (function (_super) {
                ...
                function DataGrid(app, el, dataSource, options) {
                    ...
                    this._options = utils.extend(false, {
                        ...
                        containerCss: null,
                        wrapCss: //div that wraps all table and header
                        null,
                        headerCss: //div that wraps only table without header
                        null,
                        rowStateField: //div inside which are column cells
                        null,
                        isCanEdit: null,
                        isCanDelete: null,
                        ...
                        case CH_T.REMAP_KEY:
 {
                ...
                DataGrid.prototype._appendItems = function (newItems) {
                    ...
                    for(var i = 0, k = newItems.length; i < k; i += 1) {
                        ...
                        if(!self._rowMap[item._key]) {
                            //not row for item already exists
                ...
                DataGrid.prototype._refreshGrid = //Full grid refresh
                function () {
                    var self = this, ds = this._dataSource;
                    self._clearGrid();
                    if(!ds) {
