            ...
            var Parser = (function () {
                ...
                Parser.prototype._resolveProp = function (obj, prop) {
                    ...
                    if(utils.str.startsWith(prop, '[')) {
                        //it is indexed property, obj must be of collection type
                ...
                Parser.prototype._getKeyVals = //extract key - value pairs
                function (val) {
                ...
                Parser.prototype.getBraceParts = //extract top level braces
                function (val, firstOnly) {
