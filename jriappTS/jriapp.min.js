...
[a.message]});var d=[];e.forEachProp(c,function(a){d.push({fieldName:a,errors:c[a]})});this._addErrors(b,d);return b};n.prototype._setCurrentItem=function(b){if(b&&!(b instanceof this._entityType))throw Error(a.global.utils.format(a.ERRS.ERR_PARAM_INVALID_TYPE,"currentItem",this._options.dbSetName));h.prototype._setCurrentItem.call(this,b)};n.prototype._getChanges=function(){var a=[],b=this._changeCache;e.forEachProp(b,function(c){a.push(b[c]._getRowInfo())});return a};n.prototype._getTrackAssocInfo=
function(){var a=this,b=[],c=this._changeCache,d=Object.keys(a._trackAssoc);e.forEachProp(c,function(e){var h=c[e];d.forEach(function(c){var d=h._getFieldVal(a._trackAssoc[c].childToParentName),e=h._key;d&&e&&b.push({assocName:c,parentKey:d,childKey:e})})});return b};n.prototype._getNewKey=function(a){a="clkey_"+this._newKey;this._newKey+=1;return a};n.prototype._createNew=function(){var a=new this._entityType(this,null,null);a._key=this._getNewKey(a);return a};n.prototype._addToChanged=function(a){null!==
a._key&&!this._changeCache[a._key]&&(this._changeCache[a._key]=a,this._changeCount+=1,1===this._changeCount&&this.raisePropertyChanged("hasChanges"))};n.prototype._removeFromChanged=function(a){null!==a&&this._changeCache[a]&&(delete this._changeCache[a],this._changeCount-=1,0===this._changeCount&&this.raisePropertyChanged("hasChanges"))};n.prototype._clearChangeCache=function(){var a=this._changeCount;this._changeCache={};this._changeCount=0;a!==this._changeCount&&this.raisePropertyChanged("hasChanges")};
n.prototype._onItemStatusChanged=function(a,b){h.prototype._onItemStatusChanged.call(this,a,b);a._isDeleted&&this.isSubmitOnDelete&&this.dbContext.submitChanges()};n.prototype._onRemoved=function(a,b){this._removeFromChanged(a._key);h.prototype._onRemoved.call(this,a,b)};n.prototype._onPageChanging=function(){var a=h.prototype._onPageChanging.call(this);if(!a)return a;this.hasChanges&&this.rejectChanges();return a};n.prototype._onPageChanged=function(){this.cancelEdit();h.prototype._onPageChanged.call(this);
this._ignorePageChanged||(this.query.pageIndex=this.pageIndex,this.dbContext._load(this.query,!0))};n.prototype._onPageSizeChanged=function(){h.prototype._onPageSizeChanged.call(this);this._query&&(this._query.pageSize=this.pageSize)};n.prototype._destroyItems=function(){this._items.forEach(function(a){a._isCached?a.removeHandler(null,null):a.destroy()})};n.prototype.sort=function(a,b){var c=this.query;if(c){c.clearSort();for(var d=0;d<a.length;d+=1)0==d?c.orderBy(a[d],b):c.thenBy(a[d],b);c.isClearPrevData=
!0;c.pageIndex=0;return this.dbContext.load(c)}return h.prototype.sort.call(this,a,b)};n.prototype.fillItems=function(a){a={res:e.extend(!1,{names:[],rows:[],pageIndex:this.query?this.query.pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null,rowCount:a.rows.length,extraInfo:null,error:null,included:[]},a),isPageChanged:!1,fn_beforeFillEnd:null};this._fillFromService(a)};n.prototype.defineCalculatedField=function(b,c){var d=this._calcfldMap[b];if(!d)throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,
"fieldName",b));d.getFunc=c};n.prototype.acceptChanges=function(){var a=this._changeCache;e.forEachProp(a,function(b){a[b].acceptChanges(null)});this._changeCount=0};n.prototype.rejectChanges=function(){var a=this._changeCache;e.forEachProp(a,function(b){a[b].rejectChanges()})};n.prototype.deleteOnSubmit=function(a){a.deleteOnSubmit()};n.prototype.clear=function(){this._clearChangeCache();h.prototype.clear.call(this)};n.prototype.createQuery=function(b){var c=this.dbContext._getQueryInfo(b);if(!c)throw Error(e.format(a.ERRS.ERR_QUERY_NAME_NOTFOUND,
b));return new D(this,c)};n.prototype.clearCache=function(){var a=this._query;a&&a._clearCache()};n.prototype.destroy=function(){if(!this._isDestroyed){this._isDestroyCalled=!0;var a=this._query;this._query=null;a&&a.destroy();this._navfldMap={};this._calcfldMap={};h.prototype.destroy.call(this)}};n.prototype.toString=function(){return this._options.dbSetName};Object.defineProperty(n.prototype,"items",{get:function(){return this._items},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,
"dbContext",{get:function(){return this._dbContext},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"dbSetName",{get:function(){return this._options.dbSetName},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"entityType",{get:function(){return this._entityType},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"query",{get:function(){return this._query},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"hasChanges",{get:function(){return 0<
this._changeCount},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"cacheSize",{get:function(){var a=this._query;return a&&a.isCacheValid?(a=a._getCache(),a.cacheSize):0},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"isSubmitOnDelete",{get:function(){return this._isSubmitOnDelete},set:function(a){this._isSubmitOnDelete!==a&&(this._isSubmitOnDelete=!!a,this.raisePropertyChanged("isSubmitOnDelete"))},enumerable:!0,configurable:!0});return n}(r.collection.Collection);
k.DbSet=v;v=function(c){function d(){c.call(this);this._isInitialized=!1;this._dbSets={};this._dbSetNames=[];this._arrDbSets=[];this._svcMethods={};this._assoc={};this._arrAssoc=[];this._queryInf={};this._serviceUrl=null;this._isBusy=0;this._hasChanges=this._isSubmiting=!1;this._pendingSubmit=null;this._serverTimezone=e.get_timeZoneOffset();this._waitQueue=new a.MOD.utils.WaitQueue(this)}__extends(d,c);d.prototype._getEventNames=function(){var a=c.prototype._getEventNames.call(this);return["submit_error"].concat(a)};
...
childKeyFields:a.fieldRels.map(function(a){return a.childField}),parentToChildrenName:a.parentToChildrenName,childToParentName:a.childToParentName,name:a.name},d="get"+a.name;this._assoc[d]=function(){var a=new n(c);b._arrAssoc.push(a);b._assoc[d]=function(){return a};return a}};d.prototype._initMethod=function(b){var c=this;this._svcMethods[b.methodName]=function(d){var h=e.createDeferred(),n=function(a){a.error?h.reject():h.resolve(a.result)};try{var f=c._getMethodParams(b,d);c._invokeMethod(b,
f,n)}catch(g){a.global._checkIsDummy(g)||(c._onError(g,c),n({result:null,error:g}))}return h.promise()}};d.prototype._getMethodParams=function(c,d){var h=this,n={methodName:c.methodName,paramInfo:{parameters:[]}},g,l=c.parameters,s=l.length,k,y,m;d||(d={});for(g=0;g<s;g+=1){k=l[g];y=d[k.name];if(!k.isNullable&&!k.isArray&&k.dataType!==f.DATA_TYPE.String&&e.check.isNt(y))throw Error(e.format(a.ERRS.ERR_SVC_METH_PARAM_INVALID,k.name,y,c.methodName));if(e.check.isFunction(y))throw Error(e.format(a.ERRS.ERR_SVC_METH_PARAM_INVALID,
k.name,y,c.methodName));k.isArray&&(!e.check.isNt(y)&&!e.check.isArray(y))&&(y=[y]);m=null;e.check.isArray(y)?(m=[],y.forEach(function(a){m.push(b.stringifyValue(a,k.dateConversion,h._serverTimezone))}),m=JSON.stringify(m)):m=b.stringifyValue(y,k.dateConversion,h._serverTimezone);n.paramInfo.parameters.push({name:k.name,value:m})}return n};d.prototype._invokeMethod=function(b,c,d){var h=this,n,f;this.isBusy=!0;var g=function(b){try{if(!b)throw Error(e.format(a.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));
q(b.error,"invoke");d({result:b.result,error:null})}catch(c){a.global._checkIsDummy(c)||(h._onDataOperError(c,"invoke"),d({result:null,error:c}))}};try{n=JSON.stringify(c),f=this._getUrl("InvokeMethod"),e.performAjaxCall(f,n,!0,function(a){g(JSON.parse(a));h.isBusy=!1},function(a){g({result:null,error:a});h.isBusy=!1},null)}catch(l){a.global._checkIsDummy(l)&&a.global._throwDummy(l),this.isBusy=!1,this._onDataOperError(l,"invoke"),d({result:null,error:l}),a.global._throwDummy(l)}};d.prototype._loadFromCache=
function(b,c){var d=b._dbSet,e;try{e=d._fillFromCache({isPageChanged:c,fn_beforeFillEnd:null})}catch(h){a.global._checkIsDummy(h)&&a.global._throwDummy(h),this._onDataOperError(h,"load"),a.global._throwDummy(h)}return e};d.prototype._loadIncluded=function(a){var b=this;a.included&&0<a.included.length&&a.included.forEach(function(a){b.getDbSet(a.dbSetName).fillItems(a)})};d.prototype._onLoaded=function(b,c){var d=this,h,n,f;try{if(!b)throw Error(e.format(a.ERRS.ERR_UNEXPECTED_SVC_ERROR,"null result"));
h=b.dbSetName;n=d.getDbSet(h);if(!n)throw Error(e.format(a.ERRS.ERR_DBSET_NAME_INVALID,h));q(b.error,"load");f=n._fillFromService({res:b,isPageChanged:c,fn_beforeFillEnd:function(){d._loadIncluded(b)}})}catch(g){a.global._checkIsDummy(g)&&a.global._throwDummy(g),this._onDataOperError(g,"load"),a.global._throwDummy(g)}return f};d.prototype._dataSaved=function(b){var c=this,d=[],h=[];try{try{q(b.error,g)}catch(n){throw b.dbSets.forEach(function(b){var p=c._dbSets[b.dbSetName];b.rows.forEach(function(b){var c=
p.getItemByKey(b.clientKey);if(!c)throw Error(e.format(a.ERRS.ERR_KEY_IS_NOTFOUND,b.clientKey));d.push(c);b.invalid&&(p._setItemInvalid(b),h.push(c))})}),new B(n,d,h);}b.dbSets.forEach(function(a){c._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(f){a.global._checkIsDummy(f)&&a.global._throwDummy(f),this._onSubmitError(f),a.global._throwDummy(f)}};d.prototype._getChanges=function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();
...
this._onDataOperError(d,"refresh"),a.global._throwDummy(d)}};d.prototype._refreshItem=function(a){var b=e.createDeferred(),c=function(c){c?b.resolve(a):b.reject()},d=this._getUrl("RefreshItem"),h=a._dbSet,n=this;this.waitForNotSubmiting(function(){h.waitForNotLoading(function(){var b,f=function(){n.isBusy=!1;h.isLoading=!1;a._isRefreshing=!1},g=function(a){f();n._onDataOperError(a,"refresh")};a._isRefreshing=!0;n.isBusy=!0;h.isLoading=!0;try{var l={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};
a._checkCanRefresh();b=JSON.stringify(l);e.performAjaxCall(d,b,!0,function(b){try{var d=JSON.parse(b);n._onItemRefreshed(d,a);f();c(!0)}catch(h){g(h),c(!1)}},function(a){f();n._onDataOperError(a,"refresh");c(!1)},null)}catch(s){g(s),c(!1)}},[],!0,null)},[],null);return b.promise()};d.prototype._onError=function(b,d){var h=c.prototype._onError.call(this,b,d);return!h?a.global._onError(b,d):h};d.prototype._onDataOperError=function(b,c){if(a.global._checkIsDummy(b))return!0;var d;d=b instanceof w?b:
new w(b,c);return this._onError(d,this)};d.prototype._onSubmitError=function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,g))};d.prototype._beforeLoad=function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=
a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()};d.prototype._load=function(b,c){if(!b)throw Error(a.ERRS.ERR_DB_LOAD_NO_QUERY);var d=this,h=e.createDeferred(),n=b.loadPageCount,f=b.pageIndex,g=b.isPagingEnabled,l=b.dbSetName,s=this.getDbSet(l);this.waitForNotSubmiting(function(){s.waitForNotLoading(function(){var k=s.query,y=d._getUrl("GetItems"),m,v,q=function(){s.isLoading=!1;d.isBusy=!1},x=function(a){q();h.resolve(a)},w=function(a){q();d._onDataOperError(a,"load");
h.reject()},r,z,D=1;s.isLoading=!0;d.isBusy=!0;try{b.pageIndex=f;d._beforeLoad(b,k,s);if(1<n&&g){if(b._isPageCached(f)){r=d._loadFromCache(b,c);x(r);return}z=b._getCache().getNextRange(f);f=z.start;D=z.cnt}m={dbSetName:l,pageIndex:f,pageSize:b.pageSize,pageCount:D,isIncludeTotalCount:b.isIncludeTotalCount,filterInfo:b.filterInfo,sortInfo:b.sortInfo,paramInfo:d._getMethodParams(b._queryInfo,b.params).paramInfo,queryName:b.queryName};v=JSON.stringify(m);e.performAjaxCall(y,v,!0,function(b){var p=[],
h;try{h=b.indexOf(a.MOD.consts.CHUNK_SEP),-1<h?(p.push(b.substr(0,h)),p.push(b.substr(h+a.MOD.consts.CHUNK_SEP.length))):p.push(b),p=p.map(function(a){return JSON.parse(a)}),setTimeout(function(){var b,h=p[0],n=!!h.included&&0<h.included.length;try{if(1<p.length&&(b=p[1])&&0<b.length)if(n&&h.included.forEach(function(c){c.rows=b.splice(0,c.rowCount);if(c.rowCount!=c.rows.length)throw Error(e.format(a.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),h.rows=b,h.rowCount!=h.rows.length)throw Error(e.format(a.ERRS.ERR_ASSERTION_FAILED,
"getDataResult.rowCount == getDataResult.rows.length"));r=d._onLoaded(h,c);x(r)}catch(f){w(f)}},0)}catch(n){w(n)}},function(a){q();d._onDataOperError(a,"load");h.reject()},null)}catch(t){w(t)}},[],!0,c?"paging":null)},[],c?"paging":null);return h.promise()};d.prototype.getDbSet=function(b){var c=this._dbSets[b];if(!c)throw Error(e.format(a.ERRS.ERR_DBSET_NAME_INVALID,b));return c};d.prototype.getAssociation=function(b){var c=this._assoc["get"+b];if(!c)throw Error(e.format(a.ERRS.ERR_ASSOC_NAME_INVALID,
b));return c()};d.prototype.submitChanges=function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=this,b={deferred:e.createDeferred()},c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,d,h=g,n,f=function(){a.isBusy=!1;a.isSubmiting=!1},l=function(b){f();a._onDataOperError(b,h);c(!1)};try{if(a.isBusy=!0,a.isSubmiting=!0,a._pendingSubmit=null,b=a._getUrl("SaveChanges"),n=a._getChanges(),0===n.dbSets.length){f();
c(!0);return}}catch(s){l(s);return}try{d=JSON.stringify(n),e.performAjaxCall(b,d,!0,function(b){try{a._dataSaved(JSON.parse(b)),f(),c(!0)}catch(d){l(d)}},function(b){f();a._onSubmitError(b);c(!1)},null)}catch(k){l(k)}},[]);return b.deferred.promise()};d.prototype.load=function(a){return this._load(a,!1)};d.prototype.acceptChanges=function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})};d.prototype.rejectChanges=function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})};d.prototype.initialize=
...
k.DbContext=v;var n=function(b){function h(a){b.call(this);var c=this;this._objId="ass"+e.getNewID();a=e.extend(!1,{dbContext:null,parentName:"",childName:"",parentKeyFields:[],childKeyFields:[],parentToChildrenName:null,childToParentName:null,name:this._objId,onDeleteAction:x.NoAction},a);this._name=a.name;this._dbContext=a.dbContext;this._onDeleteAction=a.onDeleteAction;this._parentDS=a.dbContext.dbSets[a.parentName];this._childDS=a.dbContext.dbSets[a.childName];this._parentFldInfos=a.parentKeyFields.map(function(a){return c._parentDS.getFieldInfo(a)});
...
h.prototype._getItemKey=function(a,b,c){for(var d=[],h,e=0,n=a.length;e<n;e+=1){h=c[a[e].fieldName];h=b._getStrValue(h,a[e]);if(null===h)return null;d.push(h)}return d.join(";")};h.prototype._resetChildMap=function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)};h.prototype._resetParentMap=function(){var a=Object.keys(this._parentMap);this._parentMap={};this._notifyParentChanged(a)};h.prototype._unMapChildItem=function(a){var b,c,d=null;if(b=this.getChildFKey(a))if(c=
this._childMap[b])a=e.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],d=b);return d};h.prototype._unMapParentItem=function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],b=a;return b};h.prototype._mapParentItems=function(a){for(var b,d,h=c.DELETED,e,n={},f=0,g=a.length;f<g;f+=1)if(b=a[f],d=b._changeType,d!==h&&(d=this.getParentFKey(b)))e=this._parentMap[d],e!==b&&(this._parentMap[d]=b,n[d]=null);return Object.keys(n)};h.prototype._onChildrenChanged=
function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)};h.prototype._onParentChanged=function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})};h.prototype._mapChildren=function(a){for(var b,d,h,e=c.DELETED,n={},f=0,g=a.length;f<g;f+=1)if(b=a[f],d=b._changeType,d!==e&&(d=this.getChildFKey(b)))h=this._childMap[d],h||(h=[],this._childMap[d]=h),0>h.indexOf(b)&&
(h.push(b),n[d]||(n[d]=null));return Object.keys(n)};h.prototype._unbindParentDS=function(){var a=this.parentDS;a&&a.removeNSHandlers(this._objId)};h.prototype._unbindChildDS=function(){var a=this.childDS;a&&a.removeNSHandlers(this._objId)};h.prototype.getParentFKey=function(a){return a&&a._isNew?a._key:this._getItemKey(this._parentFldInfos,this._parentDS,a)};h.prototype.getChildFKey=function(a){if(a&&this._childToParentName){var b=a._getFieldVal(this._childToParentName);if(b)return b}return this._getItemKey(this._childFldInfos,
...
if(b=this._dataSource)b=this._fn_itemsProvider?this._fn_itemsProvider(b):b.items,this._fn_filter&&(b=b.filter(this._fn_filter)),this._fn_sort&&(b=b.sort(this._fn_sort)),this._fillItems({items:b,isPageChanged:!!a,clear:!0,isAppend:!1}),this._onViewRefreshed({})};c.prototype._fillItems=function(a){a=e.extend(!1,{items:[],isPageChanged:!1,clear:!0,isAppend:!1},a);var b=this,c,h=[],n=[],f=[];this._onFillStart({isBegin:!0,rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&
this.clear(),c=this.isPagingEnabled&&!a.isAppend?this._filterForPaging(a.items):a.items,c.forEach(function(a){var c=b._itemsByKey[a._key];c?f.push(c):(b._itemsByKey[a._key]=a,h.push(a),n.push(b._items.length-1),b._items.push(a),f.push(a))}),0<h.length&&(this._onItemsChanged({change_type:d.ADDED,items:h,pos:n}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:f.length,time:new Date,resetUI:!!a.clear,fetchedItems:f,newItems:h,isPageChanged:a.isPageChanged})}this.totalCount=
...
d-1,this._onCurrentChanged())}};c.prototype.sortLocal=function(b,c){var d=1,h=a.global.parser;c&&"DESC"===c.toUpperCase()&&(d=-1);this.fn_sort=function(a,c){var e=0,n,f,g;n=0;for(f=b.length;n<f&&!(g=b[n],e=h.resolvePath(a,g),g=h.resolvePath(c,g),e=e<g?-1*d:e>g?d:0,0!==e);n+=1);return e}};c.prototype.getIsHasErrors=function(){return this._dataSource.getIsHasErrors()};c.prototype.clear=function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey=
...
Object.defineProperty(b.prototype,"parentItem",{get:function(){return this._parentItem},set:function(a){this._parentItem!==a&&(this._parentItem=a,this.raisePropertyChanged("parentItem"),0<this.items.length&&(this.clear(),this._onViewRefreshed({})),this._refresh())},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"association",{get:function(){return this._association},enumerable:!0,configurable:!0});return b}(v);k.ChildDataView=v;a.global.onModuleLoaded("db",k)})(r.db||(r.db={}))})(a.MOD||
(a.MOD={}))})(RIAPP||(RIAPP={}));
