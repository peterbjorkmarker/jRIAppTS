    ...
    (function (FILESDEMO) {
        ...
        var FolderBrowser = (function (_super) {
            ...
            FolderBrowser.prototype.loadRootFolder = function () {
                var self = this, query = self._foldersDb.createReadRootQuery({
            ...
            FolderBrowser.prototype.loadChildren = function (item) {
                var self = this, query = self._foldersDb.createReadChildrenQuery({
                    parentKey: item.Key,
                    level: item.Level + 1,
                    path: item.fullPath,
                    includeFiles: self._includeFiles
