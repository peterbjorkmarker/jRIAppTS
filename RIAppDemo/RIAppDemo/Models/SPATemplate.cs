...
namespace RIAppDemo.Models
{
    public class SPATemplate
    {
        public SPATemplate() 
        {
            this.BindGridCustomers = "{this.dataSource,to=dbSet,source=customerVM}{this.propChangedCommand,to=propChangeCommand,source=customerVM}";
            ...
            this.BindTableCustOrders = "{this.dataSource,to=dbSet,source=customerVM.ordersVM}{this.propChangedCommand,to=propChangeCommand,source=customerVM.ordersVM}";
