...
module RIAPP
{
    export module FOLDERBROWSER_SVC {
        'use strict';
        /*
            Generated from: /FolderBrowserService/code?lang=ts on 2014-11-27 12:49 at 12:49
        ...
        */
        ...
        export class FileSystemObject extends RIAPP.MOD.collection.CollectionItem<RIAPP.MOD.db.EntityAspect<FileSystemObject, FileSystemObjectDb, DbContext>> implements RIAPP.MOD.db.IEntityItem {

            constructor(aspect: RIAPP.MOD.db.EntityAspect<FileSystemObject, FileSystemObjectDb, DbContext>) {
                super(aspect);
        ...
        export class FileSystemObjectDb extends RIAPP.MOD.db.DbSet<FileSystemObject, DbContext>
        {
