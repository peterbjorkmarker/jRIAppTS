...
(function(a){(function(r){(function(k){function g(a,m,t){var b=t||{};Object.getOwnPropertyNames(b).forEach(function(a){a=b[a];void 0===a.enumerable&&(a.enumerable=!0);void 0===a.configurable&&(a.configurable=!1)});if(m)for(var c=Object.getOwnPropertyNames(m),d=0,f=c.length;d<f;d+=1)t=c[d],b.hasOwnProperty(t)||(b[t]=Object.getOwnPropertyDescriptor(m,t));return Object.defineProperties(a,b)}function q(a,m){function t(){this.constructor=a}t.prototype=m.prototype;a.prototype=new t}var e=a.baseUtils,f=
0;k.defineProps=g;k.__extendType=function(a,m,t){var b=function(){a.apply(this,arguments)};q(b,a);g(b.prototype,m,t);return b};var l=function(){function b(){}b.isNull=function(a){return null===a};b.isUndefined=function(a){return void 0===a};b.isNt=function(a){return null===a||void 0===a};b.isFunction=e.isFunc;b.isString=function(a){if(b.isNt(a))return!1;var t=/string/i;return"string"===typeof a?!0:"object"===typeof a?t.test(a.constructor.toString()):!1};b.isArray=e.isArray;b.isBoolean=function(a){if(b.isNt(a))return!1;
...
"false"==a};b.isProtoOf=function(a,b){return!!b&&b instanceof a};b.isBaseObj=function(m){return!!m&&m instanceof a.BaseObject};b.isBinding=function(m){return!!m&&m instanceof a.MOD.binding.Binding};b.isElView=function(m){return!!m&&m instanceof a.MOD.baseElView.BaseElView};b.isTemplateElView=function(m){return!!m&&m instanceof a.MOD.baseElView.TemplateElView};b.isEditable=function(m){return!!m&&!!m.beginEdit&&!!m.endEdit&&!!m.cancelEdit&&a.global.utils.hasProp(m,"isEditing")};b.isDataForm=function(m){if(!m)return!1;
m=m.getAttribute(a.global.consts.DATA_ATTR.DATA_VIEW);if(!m)return!1;m=a.global.parser.parseOptions(m);return 0<m.length&&m[0].name===a.global.consts.ELVIEW_NM.DATAFORM};b.isInsideDataForm=function(a){return!a?!1:(a=a.parentElement)?b.isDataForm(a)?!0:b.isInsideDataForm(a):!1};return b}();k.Checks=l;var b=function(){function a(){}a.endsWith=e.endsWith;a.startsWith=e.startsWith;a.trim=e.trim;a.formatNumber=function(a,b,c,d){a=(a+"").replace(/[^0-9+-Ee.]/g,"");var f=!isFinite(+a)?0:+a;a=!isFinite(+b)?
0:Math.abs(b);d=void 0===d?",":d;c=void 0===c?".":c;var h=[""],h=function(a,m){var p=Math.pow(10,m);return""+Math.round(a*p)/p};l.isNt(b)?(h=(""+f).split("."),a=2):h=(a?h(f,a):""+Math.round(f)).split(".");var f="",n=h[0].length;if(3<n){for(b=0;b<n;b+=1)f+=h[0].charAt(b),b<n-1&&0===(n-b-1)%3&&(f+=d);h[0]=f}if((h[1]||"").length<a)h[1]=h[1]||"",h[1]+=Array(a-h[1].length+1).join("0");return h.join(c)};a.stripNonNumeric=function(a){a+="";for(var b=/^\d|\.|-$/,c="",d=0;d<a.length;d++)b.test(a.charAt(d))&&
("."==a.charAt(d)&&-1!=c.indexOf(".")||"-"==a.charAt(d)&&0!=c.length||(c+=a.charAt(d)));return c};return a}();k.StringUtils=b;var d=function(){function b(){}b.checkNumRange=function(m,b){var c=b.split(",");if(c[0]&&m<parseFloat(c[0]))throw Error(e.format(a.ERRS.ERR_FIELD_RANGE,m,b));if(c[1]&&m>parseFloat(c[1]))throw Error(e.format(a.ERRS.ERR_FIELD_RANGE,m,b));};b._dtRangeToDate=function(a){a=a.split("-");return new Date(parseInt(a[0],10),parseInt(a[1],10)-1,parseInt(a[2],10))};b.checkDateRange=function(m,
t){var c=t.split(",");if(c[0]&&m<b._dtRangeToDate(c[0]))throw Error(e.format(a.ERRS.ERR_FIELD_RANGE,m,t));if(c[1]&&m>b._dtRangeToDate(c[1]))throw Error(e.format(a.ERRS.ERR_FIELD_RANGE,m,t));};return b}();k.Validations=d;k.valueUtils={valueToDate:function(b,m,t){if(!b)return null;b=""+b;var c=b.split("&");if(7!=c.length)throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"val",b));b=new Date(parseInt(c[0],10),parseInt(c[1],10)-1,parseInt(c[2],10),parseInt(c[3],10),parseInt(c[4],10),parseInt(c[5],10),parseInt(c[6],
10));var c=r.consts.DATE_CONVERSION,d=a.global.utils.get_timeZoneOffset();switch(m){case c.None:break;case c.ServerLocalToClientLocal:b.setMinutes(b.getMinutes()+t);b.setMinutes(b.getMinutes()-d);break;case c.UtcToClientLocal:b.setMinutes(b.getMinutes()-d);break;default:throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"dtcnv",m));}return b},dateToValue:function(b,m,t){if(null===b)return null;if(!l.isDate(b))throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"dt",b));var c=r.consts.DATE_CONVERSION,d=a.global.utils.get_timeZoneOffset();
switch(m){case c.None:break;case c.ServerLocalToClientLocal:b.setMinutes(b.getMinutes()+d);b.setMinutes(b.getMinutes()-t);break;case c.UtcToClientLocal:b.setMinutes(b.getMinutes()+d);break;default:throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"dtcnv",m));}return""+b.getFullYear()+"&"+(b.getMonth()+1)+"&"+b.getDate()+"&"+b.getHours()+"&"+b.getMinutes()+"&"+b.getSeconds()+"&"+b.getMilliseconds()},compareVals:function(a,m,b){if(null===a&&null!==m||null!==a&&null===m)return!1;var c=r.consts.DATA_TYPE;
switch(b){case c.DateTime:case c.Date:case c.Time:return l.isDate(a)&&l.isDate(m)?a.getTime()===m.getTime():!1;default:return a===m}},stringifyValue:function(a,m,b){return l.isNt(a)?null:l.isDate(a)?k.valueUtils.dateToValue(a,m,b):""+a},parseValue:function(b,m,c,d){var f=null;if(void 0===b||null===b)return f;f=r.consts.DATA_TYPE;switch(m){case f.None:f=b;break;case f.String:f=b;break;case f.Bool:f=a.global.utils.parseBool(b);break;case f.Integer:f=parseInt(b,10);break;case f.Decimal:case f.Float:f=
parseFloat(b);break;case f.DateTime:case f.Date:case f.Time:f=k.valueUtils.valueToDate(b,c,d);break;case f.Guid:case f.Binary:f=b;break;default:throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"dataType",m));}return f}};var c=function(b){function m(){b.call(this);this._objs=[]}__extends(m,b);m.create=function(){return new m};m.prototype.addObj=function(a){0>this._objs.indexOf(a)&&this._objs.push(a)};m.prototype.removeObj=function(m){a.global.utils.removeFromArray(this._objs,m)};m.prototype.getObjs=function(){return this._objs};
m.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._objs.forEach(function(a){a._isDestroyCalled||a.destroy()}),this._objs=[],b.prototype.destroy.call(this))};m.prototype.toString=function(){return"LifeTimeScope"};return m}(a.BaseObject);k.LifeTimeScope=c;var h=function(b){function m(){b.call(this);this._objId="prw"+a.global.utils.getNewID();this._objs=[]}__extends(m,b);m.create=function(){return new m};m.prototype.addPropWatch=function(a,m,b){a.addOnPropertyChange(m,
function(a,m){b(m.property)},this.uniqueID);0>this._objs.indexOf(a)&&this._objs.push(a)};m.prototype.addWatch=function(a,m,b){a.addOnPropertyChange("*",function(a,c){-1<m.indexOf(c.property)&&b(c.property)},this.uniqueID);0>this._objs.indexOf(a)&&this._objs.push(a)};m.prototype.removeWatch=function(a){a.removeNSHandlers(this.uniqueID)};m.prototype.destroy=function(){if(!this._isDestroyed){this._isDestroyCalled=!0;var a=this;this._objs.forEach(function(m){a.removeWatch(m)});this._objs=[];b.prototype.destroy.call(this)}};
m.prototype.toString=function(){return"PropWatcher "+this._objId};Object.defineProperty(m.prototype,"uniqueID",{get:function(){return this._objId},enumerable:!0,configurable:!0});return m}(a.BaseObject);k.PropWatcher=h;var x=function(b){function m(m){b.call(this);this._objId="wq"+a.global.utils.getNewID();this._owner=m;this._queue={}}__extends(m,b);m.create=function(a){return new m(a)};m.prototype._checkQueue=function(a,m){if(this._owner&&!this._owner._isDestroyCalled){var b=this,c=this._queue[a],
d;if(c&&0!=c.length){var n,f,s=null,p=[],u=[],A=[];for(n=0;n<c.length;n+=1)if(d=c[n],d.predicate(m))if(!d.group&&0==p.length){f=d;break}else d.group&&(s||(s=d.group),s===d.group&&p.push(d));if(f)u.push(f),A.push(f);else for(;0<p.length;)d=p.pop(),f||(f=d),f.lastWins?0==u.length&&u.push(d):u.push(d),A.push(d);try{if(0<u.length){for(n=c.length;0<n;)n-=1,-1<A.indexOf(c[n])&&c.splice(n,1);u.forEach(function(a){try{a.action.apply(b._owner,a.args)}catch(p){b._owner._onError(p,b)}})}}finally{0==c.length&&
(delete this._queue[a],this._owner.removeOnPropertyChange(a,this.uniqueID))}}}};m.prototype.enQueue=function(m){m=a.global.utils.extend(!1,{prop:"",groupName:null,predicate:null,action:null,actionArgs:[],lastWins:!1,syncCheck:!1},m);var b=this;if(this._owner){var c=m.prop,d=this._queue[c];d||(d=[],this._queue[c]=d,this._owner.addOnPropertyChange(c,function(a,m){setTimeout(function(){b._isDestroyCalled||b._checkQueue(c,b._owner[c])},0)},b.uniqueID));d.push({predicate:m.predicate,action:m.action,group:m.groupName,
lastWins:m.lastWins,args:!m.actionArgs?[]:m.actionArgs});m.syncCheck?b._checkQueue(c,b._owner[c]):setTimeout(function(){b._isDestroyCalled||b._checkQueue(c,b._owner[c])},0)}};m.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._owner.removeOnPropertyChange(null,this.uniqueID),this._queue={},this._owner=null,b.prototype.destroy.call(this))};m.prototype.toString=function(){return"WaitQueue "+this._objId};Object.defineProperty(m.prototype,"uniqueID",{get:function(){return this._objId},
enumerable:!0,configurable:!0});Object.defineProperty(m.prototype,"owner",{get:function(){return this._owner},enumerable:!0,configurable:!0});return m}(a.BaseObject);k.WaitQueue=x;var w=function(){function c(){this.slice=Array.prototype.slice;this.get_timeZoneOffset=function(){var a=(new Date).getTimezoneOffset();return function(){return a}}();this.format=e.format;this.uuid=function(){var a="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(b,c){var d,f=[],
h=Math.random;c=c||a.length;if(b)for(d=0;d<b;d+=1)f[d]=a[0|h()*c];else{var n;f[8]=f[13]=f[18]=f[23]="-";f[14]="4";for(d=0;36>d;d+=1)f[d]||(n=0|16*h(),f[d]=a[19==d?n&3|8:n&15])}return f.join("")}}()}c.create=function(){return new c};Object.defineProperty(c.prototype,"check",{get:function(){return l},enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"str",{get:function(){return b},enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"validation",{get:function(){return d},
enumerable:!0,configurable:!0});c.prototype.getNewID=function(){var a=f;f+=1;return a};c.prototype.isContained=function(a,b){if(!a)return!1;for(;a=a.parentNode;)if(a===b)return!0;return!1};c.prototype.parseBool=function(m){if(l.isBoolean(m))return m;var b=e.trim(m).toLowerCase();if("false"===b)return!1;if("true"===b)return!0;throw Error(this.format(a.ERRS.ERR_PARAM_INVALID,"bool_value",m));};c.prototype.round=function(a,b){return parseFloat(a.toFixed(b))};c.prototype.performAjaxCall=function(m,b,
c,d,f,h){var n=new XMLHttpRequest;n.open("POST",m,c);var e=this.createDeferred();n.responseType="text";n.onload=function(a){200==this.status&&e.resolve(this.response)};n.onerror=function(a){e.reject(Error(a.target.status))};n.ontimeout=function(){e.reject(Error("The request for "+m+" timed out."))};n.timeout=1E3*a.global.defaults.ajaxTimeOut;n.setRequestHeader("Content-Type","application/json; charset=utf-8");n.send(b);b=e.promise();d&&b.done(function(a){d.call(h,a)});f&&b.fail(function(a){f.call(h,
a)});return b};c.prototype.performAjaxGet=function(m){var b=new XMLHttpRequest;b.open("GET",m,!0);var c=this.createDeferred();b.responseType="text";b.onload=function(a){200==this.status&&c.resolve(this.response)};b.onerror=function(a){c.reject(Error(a.target.status))};b.ontimeout=function(){c.reject(Error("The request for "+m+" timed out."))};b.timeout=1E3*a.global.defaults.ajaxTimeOut;b.send(null);return c.promise()};c.prototype.extend=function(a,b,c){return a?this.cloneObj(c,b):this.mergeObj(c,
...
this.cloneObj(a[d],null)}else if(this.check.isSimpleObject(a)){c=b||{};var h,n=Object.getOwnPropertyNames(a);f=n.length;for(d=0;d<f;d+=1)h=n[d],c[h]=this.cloneObj(a[h],null)}else return a;return c};c.prototype.shallowCopy=function(a){return this.mergeObj(a,{})};c.prototype.mergeObj=function(a,b){b||(b={});if(!a)return b;for(var c=Object.getOwnPropertyNames(a),d,f=0,h=c.length;f<h;f+=1)d=c[f],b[d]=a[d];return b};c.prototype.removeFromArray=function(a,b){var c=a.indexOf(b);-1<c&&a.splice(c,1);return c};
c.prototype.insertIntoArray=function(a,b,c){a.splice(c,0,b)};c.prototype.destroyJQueryPlugin=function(a,b){if(a.data(b))a[b]("destroy")};return c}();k.Utils=w;a.global.registerType("PropWatcher",h);a.global.registerType("LifeTimeScope",c);a.global.registerType("WaitQueue",x);a.global.onModuleLoaded("utils",k)})(r.utils||(r.utils={}))})(a.MOD||(a.MOD={}))})(RIAPP||(RIAPP={}));
...
(function(a){(function(r){(function(k){var g=a.global.utils;k.NUM_CONV={None:0,Integer:1,Decimal:2,Float:3,SmallInt:4};var q=function(){function a(){}a.prototype.convertToSource=function(a,b,m){return a};a.prototype.convertToTarget=function(a,b,m){return g.check.isNt(a)?null:a};return a}();k.BaseConverter=q;var q=new q,e=function(){function b(){}b.prototype.convertToSource=function(b,c,m){return!b?null:a.global.$.datepicker.parseDate(c,b)};b.prototype.convertToTarget=function(b,c,m){return g.check.isNt(b)?
"":a.global.$.datepicker.formatDate(c,b)};b.prototype.toString=function(){return"DateConverter"};return b}();k.DateConverter=e;var e=new e,f=function(){function b(){}b.prototype.convertToSource=function(b,c,m){if(!b)return null;c=Date.parseExact(b,c);if(!c)throw Error(g.format(a.ERRS.ERR_CONV_INVALID_DATE,b));return c};b.prototype.convertToTarget=function(a,b,m){return g.check.isNt(a)?"":a.toString(b)};b.prototype.toString=function(){return"DateTimeConverter"};return b}();k.DateTimeConverter=f;var f=
new f,l=function(){function b(){}b.prototype.convertToSource=function(b,c,m){if(g.check.isNt(b))return null;m=a.global.defaults;var d=m.decimalPoint,f=4,h=b.replace(m.thousandSep,""),h=h.replace(d,"."),h=g.str.stripNonNumeric(h);if(""===h)return null;d=null;switch(c){case k.NUM_CONV.SmallInt:d=parseInt(h,10);break;case k.NUM_CONV.Integer:d=parseInt(h,10);break;case k.NUM_CONV.Decimal:f=m.decPrecision;d=g.round(parseFloat(h),f);break;case k.NUM_CONV.Float:d=parseFloat(h);break;default:d=Number(h)}if(!g.check.isNumber(d))throw Error(g.format(a.ERRS.ERR_CONV_INVALID_NUM,
b));return d};b.prototype.convertToTarget=function(b,c,m){if(g.check.isNt(b))return"";var d=a.global.defaults;m=d.decimalPoint;var f=d.thousandSep;switch(c){case k.NUM_CONV.Integer:return g.str.formatNumber(b,0,m,f);case k.NUM_CONV.Decimal:return c=d.decPrecision,g.str.formatNumber(b,c,m,f);case k.NUM_CONV.SmallInt:return g.str.formatNumber(b,0,m,"");case k.NUM_CONV.Float:return g.str.formatNumber(b,null,m,f);default:return g.str.formatNumber(b,null,m,f)}};b.prototype.toString=function(){return"NumberConverter"};
return b}();k.NumberConverter=l;var b=new l,l=function(){function a(){}a.prototype.convertToSource=function(a,c,m){return b.convertToSource(a,k.NUM_CONV.Integer,m)};a.prototype.convertToTarget=function(a,c,m){return b.convertToTarget(a,k.NUM_CONV.Integer,m)};a.prototype.toString=function(){return"IntegerConverter"};return a}();k.IntegerConverter=l;var l=new l,d=function(){function a(){}a.prototype.convertToSource=function(a,c,m){return b.convertToSource(a,k.NUM_CONV.SmallInt,m)};a.prototype.convertToTarget=
function(a,c,m){return b.convertToTarget(a,k.NUM_CONV.SmallInt,m)};a.prototype.toString=function(){return"SmallIntConverter"};return a}();k.SmallIntConverter=d;var d=new d,c=function(){function a(){}a.prototype.convertToSource=function(a,c,m){return b.convertToSource(a,k.NUM_CONV.Decimal,m)};a.prototype.convertToTarget=function(a,c,m){return b.convertToTarget(a,k.NUM_CONV.Decimal,m)};a.prototype.toString=function(){return"DecimalConverter"};return a}();k.DecimalConverter=c;var c=new c,h=function(){function a(){}
a.prototype.convertToSource=function(a,c,m){return b.convertToSource(a,k.NUM_CONV.Float,m)};a.prototype.convertToTarget=function(a,c,m){return b.convertToTarget(a,k.NUM_CONV.Float,m)};a.prototype.toString=function(){return"FloatConverter"};return a}();k.FloatConverter=h;h=new h;a.global.registerConverter("BaseConverter",q);a.global.registerConverter("dateConverter",e);a.global.registerConverter("dateTimeConverter",f);a.global.registerConverter("numberConverter",b);a.global.registerConverter("integerConverter",
...
function(a,e,b){g.str.startsWith(e,"[")?(e=this.trimQuotes(this.trimBrackets(e)),g.check.isArray(a)?a[parseInt(e,10)]=b:a[e]=b):a[e]=b};e.prototype._getKeyVals=function(a){var l,b,d,c=[],h={key:"",val:""},k=!0,q=e.__valueDelimeter1,z=e.__valueDelimeter2,m=e.__keyValDelimeter,t=function(a){a.val&&(g.check.isNumeric(a.val)?a.val=Number(a.val):g.check.isBoolString(a.val)&&(a.val=g.parseBool(a.val)));c.push(a)};for(l=0;l<a.length;l+=1){b=a.charAt(l);if("'"===b||'"'===b)d?d===b&&(d=null):d=b;!d&&"{"===
b&&!k?(b=a.substr(l),b=this.getBraceParts(b,!0)[0],h.val+=b,l+=b.length-1):!d&&b===m?h.key&&(t(h),h={key:"",val:""},k=!0):!d&&(b===q||b===z)?k=!1:k?h.key+=b:h.val+=b}h.key&&t(h);c.forEach(function(a){a.key=g.str.trim(a.key);g.check.isString(a.val)&&(a.val=g.str.trim(a.val));""===a.val&&g.str.startsWith(a.key,"this.")&&(a.val=a.key.substr(5),a.key="targetPath")});return c=c.filter(function(a){return""!==a.val})};e.prototype.resolveBindingSource=function(a,e){if(a){if(0===e.length)return a;if(0<e.length)return this.resolveBindingSource(this._resolveProp(a,
...
(function(a){(function(r){(function(k){var g=a.global.utils,q=a.global.consts,e=a.localizable.VALIDATE,f=function(a){function b(A,u,m){a.call(this,A,u,m)}__extends(b,a);return b}(a.MOD.mvvm.Command);k.PropChangedCommand=f;k.css={fieldError:"ria-field-error",errorTip:"ui-tooltip-red",commandLink:"ria-command-link"};f=function(p){function b(a,u,m){p.call(this);this._app=a;this._el=u;this._oldDisplay=this._$el=null;this._objId="elv"+g.getNewID();this._propChangedCommand=null;a._setElView(this._el,this);
this._errors=null;this._toolTip=m.tip;this._css=m.css;this._init(m);this._applyToolTip()}__extends(b,p);b.prototype._applyToolTip=function(){this._toolTip&&this._setToolTip(this.$el,this._toolTip)};b.prototype._init=function(a){this._css&&this.$el.addClass(this._css)};b.prototype.destroy=function(){if(!this._isDestroyed){this._isDestroyCalled=!0;var a=this._$el,b=this._el;a&&a.off("."+this._objId);try{this._$el=this._el=this.toolTip=this.validationErrors=this._propChangedCommand=null}finally{this._app._setElView(b,
null),this._app=null}p.prototype.destroy.call(this)}};b.prototype.invokePropChanged=function(a){a={property:a};this._propChangedCommand&&this._propChangedCommand.execute(this,a)};b.prototype._getErrorTipInfo=function(a){var p=["<b>",e.errorInfo,"</b>","<br/>"];a.forEach(function(a){var b="";a.errors.forEach(function(a){b=b+" "+a});p.push(b);b=""});return p.join("")};b.prototype._setFieldError=function(a){var p=this.$el;a?p.addClass(k.css.fieldError):p.removeClass(k.css.fieldError)};b.prototype._updateErrorUI=
function(a,p){if(a){var b=this.$el;p&&0<p.length?(g.addToolTip(b,this._getErrorTipInfo(p),k.css.errorTip),this._setFieldError(!0)):(this._setToolTip(b,this.toolTip),this._setFieldError(!1))}};b.prototype._onError=function(b,u){var m=p.prototype._onError.call(this,b,u);return!m?a.global._onError(b,u):m};b.prototype._setToolTip=function(a,p,b){g.addToolTip(a,p,b)};b.prototype.toString=function(){return"BaseElView"};Object.defineProperty(b.prototype,"$el",{get:function(){this._el&&!this._$el&&(this._$el=
...
Object.defineProperty(b.prototype,"css",{get:function(){return this._css},set:function(a){var p=this.$el;this._css!=a&&(this._css&&p.removeClass(this._css),(this._css=a)&&p.addClass(this._css),this.raisePropertyChanged("css"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"app",{get:function(){return this._app},enumerable:!0,configurable:!0});return b}(a.BaseObject);k.BaseElView=f;var l=function(a){function b(A,u,m){a.call(this,A,u,m)}__extends(b,a);Object.defineProperty(b.prototype,
"isEnabled",{get:function(){return!this.el.disabled},set:function(a){a=!!a;a!==this.isEnabled&&(this.el.disabled=!a,this.raisePropertyChanged("isEnabled"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"el",{get:function(){return this._el},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){var a=this.el;return!a?"":a.value},set:function(a){if(this._el){var p=this.el,b=p.value;a=null===a?"":""+a;b!==a&&(p.value=a,this.raisePropertyChanged("value"))}},
enumerable:!0,configurable:!0});return b}(f);k.InputElView=l;var b=function(a){function b(A,u,m){a.call(this,A,u,m);this._commandParam=this._command=null;this.isEnabled||this.$el.addClass("disabled")}__extends(b,a);b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._command&&this._command.removeNSHandlers(this._objId),this.commandParam=this.command=null,a.prototype.destroy.call(this))};b.prototype.invokeCommand=function(){var a=this,p=a.command,b=a.commandParam;p&&p.canExecute(a,
b)&&setTimeout(function(){p.canExecute(a,b)&&p.execute(a,b)},0)};b.prototype._onCommandChanged=function(){this.raisePropertyChanged("command")};b.prototype._setCommand=function(a){var p=this;a!==this._command&&(this._command&&this._command.removeNSHandlers(this._objId),(this._command=a)?(this._command.addOnCanExecuteChanged(function(a,b){p.isEnabled=a.canExecute(p,p.commandParam)},this._objId),p.isEnabled=this._command.canExecute(p,p.commandParam)):p.isEnabled=!1,this._onCommandChanged())};b.prototype.toString=
...
"commandParam",{get:function(){return this._commandParam},set:function(a){a!==this._commandParam&&(this._commandParam=a,this.raisePropertyChanged("commandParam"))},enumerable:!0,configurable:!0});return b}(f);k.CommandElView=b;var d=function(a){function b(A,u,m){a.call(this,A,u,m)}__extends(b,a);return b}(a.MOD.mvvm.Command);k.TemplateCommand=d;d=function(a){function b(A,u,m){a.call(this,A,u,m);this._template=null;this._isEnabled=!0}__extends(b,a);b.prototype.templateLoaded=function(a){var p=this._commandParam;
this._template=a;this._template.isDisabled=!this._isEnabled;this._commandParam={template:a,isLoaded:!0};this.invokeCommand();this._commandParam=p;this.raisePropertyChanged("template")};b.prototype.templateUnloading=function(a){var p=this._commandParam;try{this._commandParam={template:a,isLoaded:!1},this.invokeCommand()}finally{this._commandParam=p,this._template=null}this.raisePropertyChanged("template")};b.prototype.toString=function(){return"TemplateElView"};Object.defineProperty(b.prototype,"isEnabled",
{get:function(){return this._isEnabled},set:function(a){this._isEnabled!==a&&(this._isEnabled=a,this._template&&(this._template.isDisabled=!this._isEnabled),this.raisePropertyChanged("isEnabled"))},enumerable:!0,configurable:!0});return b}(b);k.TemplateElView=d;var c=function(p){function b(a,m,u){p.call(this,a,m,u)}__extends(b,p);b.prototype._init=function(b){p.prototype._init.call(this,b);var m;m=b.img?b.img:q.LOADER_GIF.NORMAL;this._delay=400;this._timeOut=null;g.check.isNt(b.delay)||(this._delay=
parseInt(b.delay));this._loaderPath=a.global.getImagePath(m);this._$loader=a.global.$(new Image);this._$loader.css({position:"absolute",display:"none",zIndex:"10000"});this._$loader.prop("src",this._loaderPath);this._$loader.appendTo(this.el);this._isBusy=!1};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._timeOut&&(clearTimeout(this._timeOut),this._timeOut=null),this._$loader.remove(),this._$loader=null,p.prototype.destroy.call(this))};b.prototype.toString=function(){return"BusyElView"};
Object.defineProperty(b.prototype,"isBusy",{get:function(){return this._isBusy},set:function(p){var b=this,m=function(){b._timeOut=null;b._$loader.show();b._$loader.position({of:a.global.$(b.el)})};p!==b._isBusy&&(b._isBusy=p,b._isBusy?(b._timeOut&&(clearTimeout(b._timeOut),b._timeOut=null),0<b._delay?b._timeOut=setTimeout(m,b._delay):m()):b._timeOut?(clearTimeout(b._timeOut),b._timeOut=null):b._$loader.hide(),b.raisePropertyChanged("isBusy"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,
"delay",{get:function(){return this._delay},set:function(a){a!==this._delay&&(this._delay=a,this.raisePropertyChanged("delay"))},enumerable:!0,configurable:!0});return b}(f);k.BusyElView=c;var h=function(p){function b(a,m,u){p.call(this,a,m,u);this._template=this._dataContext=null}__extends(b,p);b.prototype._templateChanged=function(){this.raisePropertyChanged("templateID");this._template&&this.$el.empty().append(this._template.el)};b.prototype.updateTemplate=function(p){var b=this;try{if(!p&&this._template){this._template.destroy();
this._template=null;b._templateChanged();return}}catch(m){this._onError(m,this),a.global._throwDummy(m)}try{this._template?this._template.templateID=p:(this._template=new a.MOD.template.Template(this.app,p),this._template.dataContext=this._dataContext,this._template.addOnPropertyChange("templateID",function(a,p){b._templateChanged()},this._objId),b._templateChanged())}catch(u){this._onError(u,this),a.global._throwDummy(u)}};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=
!0,this._template&&(this._template.destroy(),this._template=null),this._dataContext=null,p.prototype.destroy.call(this))};Object.defineProperty(b.prototype,"templateID",{get:function(){return!this._template?null:this._template.templateID},set:function(a){this.updateTemplate(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"template",{get:function(){return this._template},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"dataContext",{get:function(){return this._dataContext},
set:function(a){this._dataContext!==a&&(this._dataContext=a,this._template&&(this._template.dataContext=this._dataContext))},enumerable:!0,configurable:!0});return b}(f);k.DynaContentElView=h;var x=function(p){function b(){p.apply(this,arguments)}__extends(b,p);b.prototype._init=function(a){var b=this;p.prototype._init.call(this,a);this._val=this.el.checked;this.$el.on("change."+this._objId,function(a){a.stopPropagation();b.checked=this.checked})};b.prototype._setFieldError=function(p){var b=this.$el;
p?(p=a.global.$("<div></div>").addClass(k.css.fieldError),b.wrap(p)):0<b.parent("."+k.css.fieldError).length&&b.unwrap()};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this.$el.off("."+this._objId),p.prototype.destroy.call(this))};b.prototype.toString=function(){return"CheckBoxElView"};Object.defineProperty(b.prototype,"checked",{get:function(){return this._val},set:function(a){var p=this.el;null!==a&&(a=!!a);a!==this._val&&(this._val=a,p&&(p.checked=!!this._val),null===
this._val?this.$el.css("opacity",0.33):this.$el.css("opacity",1),this.raisePropertyChanged("checked"))},enumerable:!0,configurable:!0});return b}(l);k.CheckBoxElView=x;var w=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype._init=function(b){var m=this;a.prototype._init.call(this,b);var c=this.$el;c.on("change."+this._objId,function(a){a.stopPropagation();m.raisePropertyChanged("value")});c.on("keypress."+this._objId,function(a){a.stopPropagation();var p={keyCode:a.which,
value:a.target.value,isCancel:!1};m.raiseEvent("keypress",p);p.isCancel&&a.preventDefault()});if(b.updateOnKeyUp)c.on("keyup."+this._objId,function(a){a.stopPropagation();m.raisePropertyChanged("value")})};b.prototype._getEventNames=function(){var b=a.prototype._getEventNames.call(this);return["keypress"].concat(b)};b.prototype.addOnKeyPress=function(a,p){this.addHandler("keypress",a,p)};b.prototype.removeOnKeyPress=function(a){this.removeHandler("keypress",a)};b.prototype.toString=function(){return"TextBoxElView"};
Object.defineProperty(b.prototype,"color",{get:function(){return this.$el.css("color")},set:function(a){var p=this.$el,b=p.css("color");a!==b&&(p.css("color",a),this.raisePropertyChanged("color"))},enumerable:!0,configurable:!0});return b}(l);k.TextBoxElView=w;var z=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.toString=function(){return"EditableElView"};return b}(l);k.HiddenElView=z;var m=function(a){function b(m,c,u){a.call(this,m,c,u)}__extends(b,a);b.prototype._init=
function(b){a.prototype._init.call(this,b);var m=this;b.rows&&(this.rows=b.rows);b.cols&&(this.cols=b.cols);b.wrap&&(this.wrap=b.wrap);var c=this.$el;c.on("change."+this._objId,function(a){a.stopPropagation();m.raisePropertyChanged("value")});c.on("keypress."+this._objId,function(a){a.stopPropagation();var p={keyCode:a.which,value:a.target.value,isCancel:!1};m.raiseEvent("keypress",p);p.isCancel&&a.preventDefault()});if(b.updateOnKeyUp)c.on("keyup."+this._objId,function(a){a.stopPropagation();m.raisePropertyChanged("value")})};
b.prototype._getEventNames=function(){var b=a.prototype._getEventNames.call(this);return["keypress"].concat(b)};b.prototype.addOnKeyPress=function(a,p){this.addHandler("keypress",a,p)};b.prototype.removeOnKeyPress=function(a){this.removeHandler("keypress",a)};b.prototype.toString=function(){return"TextAreaElView"};Object.defineProperty(b.prototype,"el",{get:function(){return this._el},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){var a=this.el;return!a?
"":a.value},set:function(a){if(this._el){var p=this.el,b=p.value;a=null===a?"":""+a;b!==a&&(p.value=a,this.raisePropertyChanged("value"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"isEnabled",{get:function(){return!this.el.disabled},set:function(a){a=!!a;a!==this.isEnabled&&(this.el.disabled=!a,this.raisePropertyChanged("isEnabled"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"rows",{get:function(){var a=this.el;return!a?1:a.rows},set:function(a){var p=
this.el;if(p){var b=p.rows;a=!a?1:a;b!==a&&(p.rows=a,this.raisePropertyChanged("rows"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"cols",{get:function(){var a=this.el;return!a?1:a.cols},set:function(a){var p=this.el;if(p){var b=p.cols;a=!a?1:a;b!==a&&(p.cols=a,this.raisePropertyChanged("cols"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"wrap",{get:function(){var a=this.el;return!a?"off":a.wrap},set:function(a){var p=this.el;if(p){var b=p.wrap;a=
!a?"off":a;0>["hard","off","soft"].indexOf(a)&&(a="off");b!==a&&(p.wrap=a,this.raisePropertyChanged("wrap"))}},enumerable:!0,configurable:!0});return b}(f);k.TextAreaElView=m;var t=function(p){function b(){p.apply(this,arguments)}__extends(b,p);b.prototype._init=function(a){var b=this;p.prototype._init.call(this,a);this._val=this.el.checked;this.$el.on("change."+this._objId,function(a){a.stopPropagation();b.checked=this.checked;b._updateGroup()})};b.prototype._updateGroup=function(){var p=this.el.getAttribute("name"),
b=this;if(p){var m=this.el.parentElement;if(m){var b=this,c=b.el;a.global.$('input[type="radio"][name="'+p+'"]',m).each(function(a,p){if(c!==this){var m=b.app._getElView(this);m&&(m.checked=this.checked)}})}}};b.prototype._setFieldError=function(p){var b=this.$el;p?(p=a.global.$("<div></div>").addClass(k.css.fieldError),b.wrap(p)):0<b.parent("."+k.css.fieldError).length&&b.unwrap()};b.prototype.toString=function(){return"RadioElView"};Object.defineProperty(b.prototype,"checked",{get:function(){return this._val},
set:function(a){var p=this.el;null!==a&&(a=!!a);a!==this._val&&(this._val=a,p&&(p.checked=!!this._val),null===this._val?this.$el.css("opacity",0.33):this.$el.css("opacity",1),this.raisePropertyChanged("checked"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){return this.el.value},set:function(a){var p=this.el;if(p){var b=""+a;null===a&&(b="");b!==p.value&&(p.value=b,this.raisePropertyChanged("value"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,
"name",{get:function(){return this.el.name},enumerable:!0,configurable:!0});return b}(l);k.RadioElView=t;var B=function(a){function b(m,c,u){this._preventDefault=!1;a.call(this,m,c,u)}__extends(b,a);b.prototype._init=function(b){a.prototype._init.call(this,b);var m=this,c=this.$el;b.preventDefault&&(this._preventDefault=!0);c.on("click."+this._objId,function(a){m._onClick(a)})};b.prototype._onClick=function(a){this._preventDefault&&a.preventDefault();this.invokeCommand()};b.prototype.toString=function(){return"ButtonElView"};
Object.defineProperty(b.prototype,"value",{get:function(){return!this._el?"":this.$el.val()},set:function(a){if(this._el){var p=this.$el.val();a=null===a?"":""+a;p!==a&&(this.$el.val(a),this.raisePropertyChanged("value"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"text",{get:function(){return!this._el?"":this.$el.text()},set:function(a){if(this._el){var p=this.$el.text();a=null===a?"":""+a;p!==a&&(this.$el.text(a),this.raisePropertyChanged("text"))}},enumerable:!0,configurable:!0});
Object.defineProperty(b.prototype,"html",{get:function(){return!this._el?"":this.$el.html()},set:function(a){if(this._el){var p=this.$el.html();a=null===a?"":""+a;p!==a&&(this.$el.html(a),this.raisePropertyChanged("html"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"preventDefault",{get:function(){return this._preventDefault},set:function(a){this._preventDefault!==a&&(this._preventDefault=a,this.raisePropertyChanged("preventDefault"))},enumerable:!0,configurable:!0});return b}(b);
k.ButtonElView=B;var C=function(p){function b(a,m,c){this._image=this._imageSrc=null;this._preventDefault=!1;p.call(this,a,m,c)}__extends(b,p);b.prototype._init=function(a){p.prototype._init.call(this,a);var b=this,m=this.$el;a.imageSrc&&(this.imageSrc=a.imageSrc);a.preventDefault&&(this._preventDefault=!0);m.addClass(k.css.commandLink);m.on("click."+this._objId,function(a){b._onClick(a)})};b.prototype._onClick=function(a){this._preventDefault&&a.preventDefault();this.invokeCommand()};b.prototype._updateImage=
function(p){var b=this.$el,m=this;this._imageSrc!==p&&(this._imageSrc=p,this._image&&!p&&(a.global.$(this._image).remove(),this._image=null),p&&(this._image?this._image.src=p:(m.html=null,p=a.global.$(new Image).attr("src",p).mouseenter(function(p){m.isEnabled&&a.global.$(this).css("opacity",0.5)}).mouseout(function(p){m.isEnabled&&a.global.$(this).css("opacity",1)}).appendTo(b),this._image=p.get(0))))};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this.$el.removeClass(k.css.commandLink),
this.imageSrc=null,p.prototype.destroy.call(this))};b.prototype.toString=function(){return"AncorButtonElView"};Object.defineProperty(b.prototype,"el",{get:function(){return this._el},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"imageSrc",{get:function(){return this._imageSrc},set:function(a){this._$el&&this._imageSrc!==a&&(this._updateImage(a),this.raisePropertyChanged("imageSrc"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"html",{get:function(){return!this._el?
...
"":this.el.href},set:function(a){if(this._el){var p=this.href;a=null===a?"":""+a;p!==a&&(this.el.href=a,this.raisePropertyChanged("href"))}},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"preventDefault",{get:function(){return this._preventDefault},set:function(a){this._preventDefault!==a&&(this._preventDefault=a,this.raisePropertyChanged("preventDefault"))},enumerable:!0,configurable:!0});return b}(b);k.AnchorElView=C;var D=function(p){function b(){p.apply(this,arguments)}__extends(b,
p);b.prototype._init=function(b){this._expandedsrc=b.expandedsrc||a.global.getImagePath("collapse.jpg");this._collapsedsrc=b.collapsedsrc||a.global.getImagePath("expand.jpg");this._isExpanded=!!b.isExpanded;p.prototype._init.call(this,{imageSrc:this._isExpanded?this._expandedsrc:this._collapsedsrc})};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._collapsedsrc=this._expandedsrc=null,this._isExpanded=!1,p.prototype.destroy.call(this))};b.prototype._onCommandChanged=
function(){p.prototype._onCommandChanged.call(this);this.invokeCommand()};b.prototype._onClick=function(a){this._isExpanded=!this._isExpanded;p.prototype._onClick.call(this,a)};b.prototype.invokeCommand=function(){this.imageSrc=this._isExpanded?this._expandedsrc:this._collapsedsrc;p.prototype.invokeCommand.call(this)};b.prototype.toString=function(){return"ExpanderElView"};Object.defineProperty(b.prototype,"isExpanded",{get:function(){return this._isExpanded},set:function(a){this._isExpanded!==a&&
(this._isExpanded=a,this.invokeCommand(),this.raisePropertyChanged("isExpanded"))},enumerable:!0,configurable:!0});return b}(C);k.ExpanderElView=D;var v=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.toString=function(){return"SpanElView"};Object.defineProperty(b.prototype,"text",{get:function(){return this.$el.text()},set:function(a){var p=this.$el,b=p.text();a=null===a?"":""+a;b!==a&&(p.text(a),this.raisePropertyChanged("text"),this.raisePropertyChanged("value"))},enumerable:!0,
configurable:!0});Object.defineProperty(b.prototype,"value",{get:function(){return this.text},set:function(a){this.text=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"html",{get:function(){return this.el.innerHTML},set:function(a){var p=this.el.innerHTML;a=null===a?"":""+a;p!==a&&(this.el.innerHTML=a,this.raisePropertyChanged("html"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"color",{get:function(){return this.$el.css("color")},set:function(a){var p=
this.$el,b=p.css("color");a!==b&&(p.css("color",a),this.raisePropertyChanged("color"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"fontSize",{get:function(){return this.$el.css("font-size")},set:function(a){var p=this.$el,b=p.css("font-size");a!==b&&(p.css("font-size",a),this.raisePropertyChanged("fontSize"))},enumerable:!0,configurable:!0});return b}(f);k.SpanElView=v;var n=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.toString=function(){return"DivElView"};
Object.defineProperty(b.prototype,"borderColor",{get:function(){return this.$el.css("border-top-color")},set:function(a){var p=this.$el.css("border-top-color");a!==p&&(this.el.style.borderColor=a,this.raisePropertyChanged("borderColor"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"borderStyle",{get:function(){return this.$el.css("border-top-style")},set:function(a){var p=this.$el,b=p.css("border-top-style");a!==b&&(p.css("border-style",a),this.raisePropertyChanged("borderStyle"))},
enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"width",{get:function(){return this.$el.width()},set:function(a){var p=this.$el,b=p.width();a!==b&&(p.width(a),this.raisePropertyChanged("width"))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"height",{get:function(){return this.$el.height()},set:function(a){var p=this.$el,b=p.height();a!==b&&(p.height(a),this.raisePropertyChanged("height"))},enumerable:!0,configurable:!0});return b}(v);k.BlockElView=n;var y=function(a){function b(m,
c,d){a.call(this,m,c,d)}__extends(b,a);b.prototype.toString=function(){return"ImgElView"};Object.defineProperty(b.prototype,"el",{get:function(){return this._el},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"src",{get:function(){return this.el.src},set:function(a){this.el.src!==a&&(this.el.src=a,this.raisePropertyChanged("src"))},enumerable:!0,configurable:!0});return b}(f);k.ImgElView=y;var s=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype._init=function(b){a.prototype._init.call(this,
b);this._tabsEventCommand=null;this._tabOpts=b;this._createTabs()};b.prototype._createTabs=function(){var a=this.$el,b=this,p={select:function(a,p){b.invokeTabsEvent("select",p)},show:function(a,p){b.invokeTabsEvent("show",p)},disable:function(a,p){b.invokeTabsEvent("disable",p)},enable:function(a,p){b.invokeTabsEvent("enable",p)},add:function(a,p){b.invokeTabsEvent("add",p)},remove:function(a,p){b.invokeTabsEvent("remove",p)},load:function(a,p){b.invokeTabsEvent("load",p)}},p=g.extend(!1,p,b._tabOpts);
a.tabs(p)};b.prototype._destroyTabs=function(){g.destroyJQueryPlugin(this.$el,"tabs")};b.prototype.invokeTabsEvent=function(a,p){var b={eventName:a,args:p};this._tabsEventCommand&&this._tabsEventCommand.execute(this,b)};b.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._tabsEventCommand=null,this._destroyTabs(),a.prototype.destroy.call(this))};b.prototype.toString=function(){return"TabsElView"};Object.defineProperty(b.prototype,"tabsEventCommand",{get:function(){return this._tabsEventCommand},
set:function(a){var p=this._tabsEventCommand;a!==p&&(p&&this._destroyTabs(),(this._tabsEventCommand=a)&&this._createTabs())},enumerable:!0,configurable:!0});return b}(f);k.TabsElView=s;a.global.registerType("BaseElView",f);a.global.registerType("InputElView",l);a.global.registerType("CommandElView",b);a.global.registerType("TemplateElView",d);a.global.registerElView("template",d);a.global.registerType("BusyElView",c);a.global.registerElView("busy_indicator",c);a.global.registerType("DynaContentElView",
h);a.global.registerElView(a.global.consts.ELVIEW_NM.DYNACONT,h);a.global.registerType("CheckBoxElView",x);a.global.registerElView("input:checkbox",x);a.global.registerType("TextBoxElView",w);a.global.registerElView("input:text",w);a.global.registerType("HiddenElView",z);a.global.registerElView("input:hidden",z);a.global.registerType("TextAreaElView",m);a.global.registerElView("textarea",m);a.global.registerType("RadioElView",t);a.global.registerElView("input:radio",t);a.global.registerType("ButtonElView",
B);a.global.registerElView("input:button",B);a.global.registerElView("input:submit",B);a.global.registerElView("button",B);a.global.registerType("AnchorElView",C);a.global.registerElView("a",C);a.global.registerElView("abutton",C);a.global.registerType("ExpanderElView",D);a.global.registerElView("expander",D);a.global.registerType("SpanElView",v);a.global.registerElView("span",v);a.global.registerType("BlockElView",n);a.global.registerElView("div",n);a.global.registerElView("section",n);a.global.registerElView("block",
n);a.global.registerType("ImgElView",y);a.global.registerElView("img",y);a.global.registerType("TabsElView",s);a.global.registerElView("tabs",s);a.global.onModuleLoaded("baseElView",k)})(r.baseElView||(r.baseElView={}))})(a.MOD||(a.MOD={}))})(RIAPP||(RIAPP={}));
...
function(){var a=this;return function(d,c){a._onSrcErrorsChanged()}};l.prototype._onSrcErrorsChanged=function(){var a=[],d=this._targetObj,c=this._sourceObj,e=this._srcPath;d&&g.check.isElView(d)&&(c&&0<e.length&&(a=c.getFieldErrors(e[e.length-1])),d.validationErrors=a)};l.prototype._onError=function(b,d){var c=e.prototype._onError.call(this,b,d);return!c?a.global._onError(b,d):c};l.prototype._getTgtChangedFn=function(b,d,c,e,f){return function(g,l){var m=a.global.parser._resolveProp(d,c);0<e.length&&
b._checkBounded(null,"target",f,e);b._parseTgtPath(m,e,f)}};l.prototype._getSrcChangedFn=function(b,d,c,e,f){return function(g,l){var m=a.global.parser._resolveProp(d,c);0<e.length&&b._checkBounded(null,"source",f,e);b._parseSrcPath(m,e,f)}};l.prototype._parseSrcPath=function(a,d,c){this._sourceObj=null;0===d.length?this._sourceObj=a:this._parseSrcPath2(a,d,c);this._targetObj&&this._updateTarget()};l.prototype._parseSrcPath2=function(b,d,c){var e=!!b&&g.check.isBaseObj(b);e&&(b.addOnDestroyed(this._getOnSrcDestroyedProxy(),
...
this._type_name=c;if(g.check.isArray(d)){this._props=d;if(0===this._props.length)throw Error(g.format(a.ERRS.ERR_PARAM_INVALID,"properties",d));this._initFieldMap(!1,d)}else if(d instanceof b)this._props=d.getFieldNames(),this._initFieldMap(!0,d);else if(d)this._props=Object.keys(d),this._initFieldMap(!1,d);else throw Error(g.format(a.ERRS.ERR_PARAM_INVALID,"properties",d));this._itemType=null;this._createItemType()}__extends(h,e);h.create=function(a,b){return new h(a,b)};h.prototype._initFieldMap=
function(a,b){var c=this;a?this._props.forEach(function(a){c._fieldMap[a]=g.extend(!1,{},b.getFieldInfo(a))}):this._props.forEach(function(a){c._fieldMap[a]=d.getEmptyFieldInfo(a)})};h.prototype._attach=function(b){try{this.endEdit()}catch(c){a.global.reThrow(c,this._onError(c,this))}return e.prototype._attach.call(this,b)};h.prototype._createNew=function(){var a=new this._itemType(null);a._key=this._getNewKey(null);return a};h.prototype._createItemType=function(){var b={},d=this;this.getFieldNames().forEach(function(a){b[a]=
{set:function(b){this._setProp(a,b)},get:function(){return this._getProp(a)}}},this);this._itemType=a.MOD.utils.__extendType(c,{__coll:this,toString:function(){return d._type_name+"Item"}},b)};h.prototype._getNewKey=function(a){a="clkey_"+this._newKey;this._newKey+=1;return a};h.prototype.fillItems=function(a,b){var c=this,d=[],e=[],h=[];this._onFillStart({isBegin:!0,rowCount:a.length,time:new Date,isPageChanged:!1});try{b&&this.clear(),a.forEach(function(a){a=new c._itemType(a);a._key=c._getNewKey(a);
var b=c._itemsByKey[a._key];b?h.push(b):(c._items.push(a),c._itemsByKey[a._key]=a,d.push(a),e.push(c._items.length-1),h.push(a))}),0<d.length&&(this._onItemsChanged({change_type:f.ADDED,items:d,pos:e}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:h.length,time:new Date,resetUI:!!b,fetchedItems:h,newItems:d,isPageChanged:!1})}this.moveFirst()};h.prototype.getNewObjects=function(){return this._items.filter(function(a){return a._isNew})};h.prototype.resetNewObjects=
function(){this._items.forEach(function(a){a._resetIsNew()})};h.prototype.toString=function(){return this._type_name};return h}(d);k.List=h;var x=function(b){function c(d,e,h){if(!h)throw Error(g.format(a.ERRS.ERR_PARAM_INVALID,"keyName",h));this._keyName=h;b.call(this,d,e);d=this.getFieldInfo(h);if(!d)throw Error(g.format(a.ERRS.ERR_DICTKEY_IS_NOTFOUND,h));d.isPrimaryKey=1}__extends(c,b);c.create=function(a,b,d){return new c(a,b,d)};c.prototype._getNewKey=function(c){if(!c)return b.prototype._getNewKey.call(this,
null);c=c[this._keyName];if(g.check.isNt(c))throw Error(g.format(a.ERRS.ERR_DICTKEY_IS_EMPTY,this._keyName));return""+c};return c}(h);k.Dictionary=x;a.global.registerType("List",h);a.global.registerType("Dictionary",x);a.global.onModuleLoaded("collection",k)})(r.collection||(r.collection={}))})(a.MOD||(a.MOD={}))})(RIAPP||(RIAPP={}));
...
h.converter=c.converter);n?q.check.isString(n)?h.target="this"==n?d:a.global.parser.resolveBindingSource(b,a.global.parser._getPathParts(n)):h.target=n:h.target=d;f?(h.isSourceFixed=!0,q.check.isString(f)?h.source="this"==f?d:a.global.parser.resolveBindingSource(b,a.global.parser._getPathParts(f)):h.source=f):h.source=e;return h}var q=a.global.utils,e=a.global.consts;k.css={content:"ria-content-field",required:"ria-required-field"};k.parseContentAttr=function(b){var c={name:null,templateInfo:null,
...
return c};k.getBindingOptions=g;var f=function(b){function c(d,e,h,f,n){b.call(this);this._app=d;this._parentEl=e;this._el=null;this._options=h;this._isReadOnly=!!this._options.readOnly;this._isEditing=!!n;this._dctx=f;this._tgt=this._lfScope=null;a.global.$(this._parentEl).addClass(k.css.content);this._init();this.update()}__extends(c,b);c.prototype._init=function(){};c.prototype._updateCss=function(){var b=this._getDisplayInfo(),c=a.global.$(this._parentEl),d=this.getFieldInfo();this._isEditing&&
...
(function(a){(function(r){(function(k){var g;function q(b,c){if(b)switch(b.name){case "AccessDeniedException":throw new z(a.ERRS.ERR_ACCESS_DENIED,c);case "ConcurrencyException":throw new m(a.ERRS.ERR_CONCURRENCY,c);case "ValidationException":throw new t(e.format(a.ERRS.ERR_VALIDATION,b.message),c);case "DomainServiceException":throw new w(e.format(a.ERRS.ERR_SVC_ERROR,b.message),c);default:throw new w(e.format(a.ERRS.ERR_UNEXPECTED_SVC_ERROR,b.message),c);}}var e=a.global.utils,f=a.global.consts,
l=r.binding.ValidationError,b=a.MOD.utils.valueUtils,d=a.MOD.collection.consts.COLL_CHANGE_TYPE,c=a.MOD.consts.CHANGE_TYPE,h=r.collection.consts.SORT_ORDER;g="submit";var x={NoAction:0,Cascade:1,SetNulls:2},w=function(a){function b(c,d){var e;c&&(e=c.message);e||(e=""+c);a.call(this,e);this._origError=c;this._operationName=d}__extends(b,a);Object.defineProperty(b.prototype,"operationName",{get:function(){return this._operationName},enumerable:!0,configurable:!0});return b}(a.MOD.errors.BaseError);
k.DataOperationError=w;var z=function(a){function b(){a.apply(this,arguments)}__extends(b,a);return b}(w);k.AccessDeniedError=z;var m=function(a){function b(){a.apply(this,arguments)}__extends(b,a);return b}(w);k.ConcurrencyError=m;var t=function(a){function b(){a.apply(this,arguments)}__extends(b,a);return b}(w);k.SvcValidationError=t;var B=function(a){function b(c,d,h){var s=c.message||""+c;a.call(this,s,g);this._origError=c;this._allSubmitted=d||[];this._notValidated=h||[];if(0<this._notValidated.length){var n=
[s+":"];this._notValidated.forEach(function(a){n.push(e.format("item key:{0} errors:{1}",a._key,a.getErrorString()))});this._message=n.join("\r\n")}}__extends(b,a);Object.defineProperty(b.prototype,"allSubmitted",{get:function(){return this._allSubmitted},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"notValidated",{get:function(){return this._notValidated},enumerable:!0,configurable:!0});return b}(w);k.SubmitError=B;var C=function(b){function c(a){b.call(this);this._query=a;this._cache=
...
1;this._isClearCacheOnEveryLoad=!0;this._dataCache=null;this._cacheInvalidated=!1}__extends(d,c);d.prototype.getFieldInfo=function(a){return this._dbSet.getFieldInfo(a)};d.prototype.getFieldNames=function(){return e.getProps(this._dbSet._fieldMap)};d.prototype._addSort=function(a,b){var c=h.ASC,d=this._sortInfo;b&&"d"===b.toLowerCase().substr(0,1)&&(c=h.DESC);d.sortItems.push({fieldName:a,sortOrder:c});this._cacheInvalidated=!0};d.prototype._addFilterItem=function(c,d,h){var n=0,n=this.getFieldInfo(c);
if(!n)throw Error(e.format(a.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,c));var f=this._serverTimezone,s=n.dateConversion,g=h;e.check.isArray(g)||(g=[h]);g=a.ArrayHelper.clone(g).map(function(a){return b.stringifyValue(a,s,f)});switch(d.toLowerCase()){case "equals":case "=":n=0;break;case "noteq":case "!=":case "<>":n=9;break;case "between":n=1;if(2!=h.length)throw Error(a.ERRS.ERR_QUERY_BETWEEN);break;case "startswith":n=2;break;case "endswith":n=3;break;case "contains":n=4;break;case "gt":case ">":n=
5;break;case "gteq":case ">=":n=7;break;case "lt":case "<":n=6;break;case "lteq":case "<=":n=8;break;default:throw Error(e.format(a.ERRS.ERR_QUERY_OPERATOR_INVALID,d));}this._filterInfo.filterItems.push({fieldName:c,kind:n,values:g});this._cacheInvalidated=!0};d.prototype.where=function(a,b,c){this._addFilterItem(a,b,c);return this};d.prototype.and=function(a,b,c){this._addFilterItem(a,b,c);return this};d.prototype.orderBy=function(a,b){this._addSort(a,b);return this};d.prototype.thenBy=function(a,
...
{get:function(){return this.__changeType!==c.NONE},enumerable:!0,configurable:!0});return h}(r.collection.CollectionItem);k.Entity=v;v=function(h){function n(a){h.call(this);var b=a.dbSetInfo;this._dbContext=a.dbContext;this._options.dbSetName=b.dbSetName;this._options.enablePaging=b.enablePaging;this._options.pageSize=b.pageSize;this._entityType=this._query=null;this._isSubmitOnDelete=!1;this._navfldMap={};this._calcfldMap={};this._trackAssoc={};this._trackAssocMap={};this._childAssocMap={};this._parentAssocMap=
{};this._changeCount=0;this._changeCache={};this._ignorePageChanged=!1;Object.freeze(this._perms)}__extends(n,h);n.prototype.getFieldInfo=function(b){var c,d=b.split(".");if(1==d.length)return this._fieldMap[b];if(1<d.length&&(c=this._childAssocMap[d[0]]))return c=this.dbContext.getDbSet(c.parentDbSetName),b=d.slice(1).join("."),c.getFieldInfo(b);throw Error(e.format(a.ERRS.ERR_DBSET_INVALID_FIELDNAME,this.dbSetName,b));};n.prototype._onError=function(a,b){return this.dbContext._onError(a,b)};n.prototype._mapAssocFields=
function(){for(var a=this._trackAssoc,b,c=Object.keys(a),d,h=this._trackAssocMap,n=0,f=c.length;n<f;n+=1){b=a[c[n]];for(var g=0,s=b.fieldRels.length;g<s;g+=1)d=b.fieldRels[g],e.check.isArray(h[d.childField])?h[d.childField].push(b.childToParentName):h[d.childField]=[b.childToParentName]}};n.prototype._updatePermissions=function(a){this._perms=a};n.prototype._getChildToParentNames=function(a){return this._trackAssocMap[a]};n.prototype._getStrValue=function(a,c){return b.stringifyValue(a,c.dateConversion,
this.dbContext.serverTimezone)};n.prototype._doNavigationField=function(b,c){var d=this,h=!0,n={getFunc:function(){throw Error("Function is not implemented");},setFunc:function(a){throw Error("Function is not implemented");}},f=b.childAssoc.filter(function(a){return a.childToParentName==c.fieldName});0===f.length&&(f=b.parentAssoc.filter(function(a){return a.parentToChildrenName==c.fieldName}),h=!1);if(1!=f.length)throw Error(e.format(a.ERRS.ERR_PARAM_INVALID_TYPE,"assocs","Array"));var g=f[0].name;
c.isClientOnly=!0;c.isReadOnly=!0;h?(c.isReadOnly=!1,d._childAssocMap[f[0].childToParentName]=f[0],f[0].fieldRels.forEach(function(a){a=d._fieldMap[a.childField];!c.isReadOnly&&a.isReadOnly&&(c.isReadOnly=!0)}),n.getFunc=function(){return d.dbContext.getAssociation(g).getParentItem(this)},c.isReadOnly||(d._trackAssoc[g]=f[0],n.setFunc=function(b){var p,h,n=d.dbContext.getAssociation(g);if(b&&!(b instanceof n.parentDS.entityType))throw Error(e.format(a.ERRS.ERR_PARAM_INVALID_TYPE,"value",n.parentDS.dbSetName));
if(b&&b._isNew)this._setFieldVal(c.fieldName,b._key);else if(b){p=0;for(h=n.childFldInfos.length;p<h;p+=1)this[n.childFldInfos[p].fieldName]=b[n.parentFldInfos[p].fieldName]}else{this._getFieldVal(c.fieldName)&&this._setFieldVal(c.fieldName,null);p=0;for(h=n.childFldInfos.length;p<h;p+=1)this[n.childFldInfos[p].fieldName]=null}})):(d._parentAssocMap[f[0].parentToChildrenName]=f[0],n.getFunc=function(){return d.dbContext.getAssociation(g).getChildItems(this)});return n};n.prototype._doCalculatedField=
function(b,c){function d(b){b.dependentOn.split(",").forEach(function(c){var d=h._fieldMap[c];if(!d)throw Error(e.format(a.ERRS.ERR_CALC_FIELD_DEFINE,c));if(b.fieldName===c)throw Error(e.format(a.ERRS.ERR_CALC_FIELD_SELF_DEPEND,c));0>d.dependents.indexOf(b.fieldName)&&d.dependents.push(b.fieldName)})}var h=this;c.isClientOnly=!0;c.isReadOnly=!0;c.dependentOn&&d(c);return{getFunc:function(){throw Error(e.format("Calculated field:'{0}' is not initialized",c.fieldName));}}};n.prototype._fillFromService=
function(b){b=e.extend(!1,{res:{names:[],rows:[],pageIndex:null,pageCount:null,dbSetName:this.dbSetName,totalCount:null},isPageChanged:!1,fn_beforeFillEnd:null},b);var c=this,h=b.res,n=h.names,f=h.rows||[],g=this._entityType,s=[],l=[],k=[],y=[],m=this.isPagingEnabled,v=this.query,q=!0,x;this._onFillStart({isBegin:!0,rowCount:f.length,time:new Date,isPageChanged:b.isPageChanged});try{v&&(q=v.isClearPrevData,v.isClearCacheOnEveryLoad&&v._clearCache(),q&&this.clear(),v._reindexCache(),1<v.loadPageCount&&
m&&(x=v._getCache(),v.isIncludeTotalCount&&!e.check.isNt(h.totalCount)&&(x.totalCount=h.totalCount)));k=f.map(function(b){var d=b.key;if(!d)throw Error(a.ERRS.ERR_KEY_IS_EMPTY);var p=c._itemsByKey[d];p?b.values.forEach(function(a,b){p._refreshValue(a,n[b],1)}):(x&&(p=x.getItemByKey(d)),p?b.values.forEach(function(a,b){p._refreshValue(a,n[b],1)}):p=new g(c,b,n));return p});if(v&&(v.isIncludeTotalCount&&!e.check.isNt(h.totalCount)&&(this.totalCount=h.totalCount),1<v.loadPageCount&&m)){x.fillCache(h.pageIndex,
k);var w=x.getCachedPage(v.pageIndex),k=w?w.items:[]}k.forEach(function(a){var b=this._itemsByKey[a._key];b?y.push(b):(this._items.push(a),this._itemsByKey[a._key]=a,s.push(a),l.push(this._items.length-1),y.push(a))},this);0<s.length&&(this._onItemsChanged({change_type:d.ADDED,items:s,pos:l}),this.raisePropertyChanged("count"));b.fn_beforeFillEnd&&b.fn_beforeFillEnd()}finally{this._onFillEnd({isBegin:!1,rowCount:y.length,time:new Date,resetUI:q,fetchedItems:y,newItems:s,isPageChanged:b.isPageChanged})}this.moveFirst();
return{fetchedItems:y,newItems:s,isPageChanged:b.isPageChanged,outOfBandData:b.res.extraInfo}};n.prototype._fillFromCache=function(b){b=e.extend(!1,{isPageChanged:!1,fn_beforeFillEnd:null},b);var c=this,h=[],n=[],f=this.query;if(!f)throw Error(e.format(a.ERRS.ERR_ASSERTION_FAILED,"query is not null"));f=f._getCache().getCachedPage(f.pageIndex);f=!f?[]:f.items;this._onFillStart({isBegin:!0,rowCount:f.length,time:new Date,isPageChanged:b.isPageChanged});try{this.clear(),this._items=f,f.forEach(function(a,
b){c._itemsByKey[a._key]=a;h.push(b);n.push(a)}),b.fn_beforeFillEnd&&b.fn_beforeFillEnd(),0<n.length&&(this._onItemsChanged({change_type:d.ADDED,items:n,pos:h}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:n.length,time:new Date,resetUI:!0,fetchedItems:n,newItems:n,isPageChanged:b.isPageChanged})}this.moveFirst();return{fetchedItems:n,newItems:n,isPageChanged:b.isPageChanged,outOfBandData:null}};n.prototype._commitChanges=function(b){var h=this;b.forEach(function(b){var p=
b.clientKey,n=h._itemsByKey[p];if(!n)throw Error(e.format(a.ERRS.ERR_KEY_IS_NOTFOUND,p));var f=n._changeType;n.acceptChanges(b);f===c.ADDED&&(delete h._itemsByKey[p],n._updateKeys(b.serverKey),h._itemsByKey[n._key]=n,h._onItemsChanged({change_type:d.REMAP_KEY,items:[n],old_key:p,new_key:n._key}))})};n.prototype._setItemInvalid=function(a){var b=this._itemsByKey[a.clientKey],c={};a.invalid.forEach(function(a){a.fieldName||(a.fieldName="*");c[a.fieldName]?c[a.fieldName].push(a.message):c[a.fieldName]=
[a.message]});var d=[];e.forEachProp(c,function(a){d.push({fieldName:a,errors:c[a]})});this._addErrors(b,d);return b};n.prototype._getChanges=function(){var a=[],b=this._changeCache;e.forEachProp(b,function(c){a.push(b[c]._getRowInfo())});return a};n.prototype._getTrackAssocInfo=function(){var a=this,b=[],c=this._changeCache,d=Object.keys(a._trackAssoc);e.forEachProp(c,function(e){var h=c[e];d.forEach(function(c){var d=h._getFieldVal(a._trackAssoc[c].childToParentName),e=h._key;d&&e&&b.push({assocName:c,
parentKey:d,childKey:e})})});return b};n.prototype._getNewKey=function(a){a="clkey_"+this._newKey;this._newKey+=1;return a};n.prototype._createNew=function(){var a=new this._entityType(this,null,null);a._key=this._getNewKey(a);return a};n.prototype._addToChanged=function(a){null!==a._key&&!this._changeCache[a._key]&&(this._changeCache[a._key]=a,this._changeCount+=1,1===this._changeCount&&this.raisePropertyChanged("hasChanges"))};n.prototype._removeFromChanged=function(a){null!==a&&this._changeCache[a]&&
(delete this._changeCache[a],this._changeCount-=1,0===this._changeCount&&this.raisePropertyChanged("hasChanges"))};n.prototype._clearChangeCache=function(){var a=this._changeCount;this._changeCache={};this._changeCount=0;a!==this._changeCount&&this.raisePropertyChanged("hasChanges")};n.prototype._onItemStatusChanged=function(a,b){h.prototype._onItemStatusChanged.call(this,a,b);a._isDeleted&&this.isSubmitOnDelete&&this.dbContext.submitChanges()};n.prototype._onRemoved=function(a,b){this._removeFromChanged(a._key);
h.prototype._onRemoved.call(this,a,b)};n.prototype._onPageChanging=function(){var a=h.prototype._onPageChanging.call(this);if(!a)return a;this.hasChanges&&this.rejectChanges();return a};n.prototype._onPageChanged=function(){this.cancelEdit();h.prototype._onPageChanged.call(this);this._ignorePageChanged||(this.query.pageIndex=this.pageIndex,this.dbContext._load(this.query,!0))};n.prototype._onPageSizeChanged=function(){h.prototype._onPageSizeChanged.call(this);this._query&&(this._query.pageSize=this.pageSize)};
n.prototype._destroyItems=function(){this._items.forEach(function(a){a._isCached?a.removeHandler(null,null):a.destroy()})};n.prototype.sort=function(a,b){var c=this.query;if(c){c.clearSort();for(var d=0;d<a.length;d+=1)0==d?c.orderBy(a[d],b):c.thenBy(a[d],b);c.isClearPrevData=!0;c.pageIndex=0;return this.dbContext.load(c)}return h.prototype.sort.call(this,a,b)};n.prototype.fillItems=function(a){a={res:e.extend(!1,{names:[],rows:[],pageIndex:this.query?this.query.pageIndex:null,pageCount:null,dbSetName:this.dbSetName,
totalCount:null,rowCount:a.rows.length,extraInfo:null,error:null,included:[]},a),isPageChanged:!1,fn_beforeFillEnd:null};this._fillFromService(a)};n.prototype.defineCalculatedField=function(b,c){var d=this._calcfldMap[b];if(!d)throw Error(e.format(a.ERRS.ERR_PARAM_INVALID,"fieldName",b));d.getFunc=c};n.prototype.acceptChanges=function(){var a=this._changeCache;e.forEachProp(a,function(b){a[b].acceptChanges(null)});this._changeCount=0};n.prototype.rejectChanges=function(){var a=this._changeCache;e.forEachProp(a,
function(b){a[b].rejectChanges()})};n.prototype.deleteOnSubmit=function(a){a.deleteOnSubmit()};n.prototype.clear=function(){this._clearChangeCache();h.prototype.clear.call(this)};n.prototype.createQuery=function(b){var c=this.dbContext._getQueryInfo(b);if(!c)throw Error(e.format(a.ERRS.ERR_QUERY_NAME_NOTFOUND,b));return new D(this,c)};n.prototype.clearCache=function(){var a=this._query;a&&a._clearCache()};n.prototype.destroy=function(){if(!this._isDestroyed){this._isDestroyCalled=!0;var a=this._query;
this._query=null;a&&a.destroy();this._navfldMap={};this._calcfldMap={};h.prototype.destroy.call(this)}};n.prototype.toString=function(){return this._options.dbSetName};Object.defineProperty(n.prototype,"items",{get:function(){return this._items},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"dbContext",{get:function(){return this._dbContext},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"dbSetName",{get:function(){return this._options.dbSetName},enumerable:!0,
configurable:!0});Object.defineProperty(n.prototype,"entityType",{get:function(){return this._entityType},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"query",{get:function(){return this._query},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"hasChanges",{get:function(){return 0<this._changeCount},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"cacheSize",{get:function(){var a=this._query;return a&&a.isCacheValid?(a=a._getCache(),a.cacheSize):
0},enumerable:!0,configurable:!0});Object.defineProperty(n.prototype,"isSubmitOnDelete",{get:function(){return this._isSubmitOnDelete},set:function(a){this._isSubmitOnDelete!==a&&(this._isSubmitOnDelete=!!a,this.raisePropertyChanged("isSubmitOnDelete"))},enumerable:!0,configurable:!0});return n}(r.collection.Collection);k.DbSet=v;v=function(c){function d(){c.call(this);this._isInitialized=!1;this._dbSets={};this._dbSetNames=[];this._arrDbSets=[];this._svcMethods={};this._assoc={};this._arrAssoc=[];
this._queryInf={};this._serviceUrl=null;this._isBusy=0;this._hasChanges=this._isSubmiting=!1;this._pendingSubmit=null;this._serverTimezone=e.get_timeZoneOffset();this._waitQueue=new a.MOD.utils.WaitQueue(this)}__extends(d,c);d.prototype._getEventNames=function(){var a=c.prototype._getEventNames.call(this);return["submit_error"].concat(a)};d.prototype.addOnSubmitError=function(a,b){this.addHandler("submit_error",a,b)};d.prototype.removeOnSubmitError=function(a){this.removeHandler("submit_error",a)};
d.prototype._onGetCalcField=function(a){this.raiseEvent("define_calc",a)};d.prototype._getQueryInfo=function(a){return this._queryInf[a]};d.prototype._createDbSets=function(){var a=this;this._dbSetNames.forEach(function(b){b=a._dbSets[b];a._arrDbSets.push(b);b.addOnPropertyChange("hasChanges",function(b,c){a._onDbSetHasChangesChanged(b)},null)});Object.freeze(this._dbSets)};d.prototype._initDbSets=function(){if(this._isInitialized)throw Error(a.ERRS.ERR_DOMAIN_CONTEXT_INITIALIZED);this._createDbSets()};
d.prototype._initAssociations=function(a){var b=this;a.forEach(function(a){b._initAssociation(a)})};d.prototype._initMethods=function(a){var b=this;a.forEach(function(a){a.isQuery?b._queryInf[a.methodName]=a:b._initMethod(a)})};d.prototype._updatePermissions=function(a){var b=this;this._serverTimezone=a.serverTimezone;a.permissions.forEach(function(a){b.getDbSet(a.dbSetName)._updatePermissions(a)})};d.prototype._onDbSetHasChangesChanged=function(a){var b=this._hasChanges;this._hasChanges=!1;if(a.hasChanges)this._hasChanges=
!0;else for(var c=0,d=this._arrDbSets.length;c<d;c+=1)if(a=this._arrDbSets[c],a.hasChanges){this._hasChanges=!0;break}this._hasChanges!==b&&this.raisePropertyChanged("hasChanges")};d.prototype._initAssociation=function(a){var b=this,c={dbContext:b,parentName:a.parentDbSetName,childName:a.childDbSetName,onDeleteAction:a.onDeleteAction,parentKeyFields:a.fieldRels.map(function(a){return a.parentField}),childKeyFields:a.fieldRels.map(function(a){return a.childField}),parentToChildrenName:a.parentToChildrenName,
childToParentName:a.childToParentName,name:a.name},d="get"+a.name;this._assoc[d]=function(){var a=new n(c);b._arrAssoc.push(a);b._assoc[d]=function(){return a};return a}};d.prototype._initMethod=function(b){var c=this;this._svcMethods[b.methodName]=function(d){var h=e.createDeferred(),n=function(a){a.error?h.reject():h.resolve(a.result)};try{var f=c._getMethodParams(b,d);c._invokeMethod(b,f,n)}catch(g){a.global._checkIsDummy(g)||(c._onError(g,c),n({result:null,error:g}))}return h.promise()}};d.prototype._getMethodParams=
function(c,d){var h=this,n={methodName:c.methodName,paramInfo:{parameters:[]}},g,l=c.parameters,s=l.length,k,y,m;d||(d={});for(g=0;g<s;g+=1){k=l[g];y=d[k.name];if(!k.isNullable&&!k.isArray&&k.dataType!==f.DATA_TYPE.String&&e.check.isNt(y))throw Error(e.format(a.ERRS.ERR_SVC_METH_PARAM_INVALID,k.name,y,c.methodName));if(e.check.isFunction(y))throw Error(e.format(a.ERRS.ERR_SVC_METH_PARAM_INVALID,k.name,y,c.methodName));k.isArray&&(!e.check.isNt(y)&&!e.check.isArray(y))&&(y=[y]);m=null;e.check.isArray(y)?
(m=[],y.forEach(function(a){m.push(b.stringifyValue(a,k.dateConversion,h._serverTimezone))}),m=JSON.stringify(m)):m=b.stringifyValue(y,k.dateConversion,h._serverTimezone);n.paramInfo.parameters.push({name:k.name,value:m})}return n};d.prototype._invokeMethod=function(b,c,d){var h=this,n,f;this.isBusy=!0;var g=function(b){try{if(!b)throw Error(e.format(a.ERRS.ERR_UNEXPECTED_SVC_ERROR,"operation result is undefined"));q(b.error,"invoke");d({result:b.result,error:null})}catch(c){a.global._checkIsDummy(c)||
(h._onDataOperError(c,"invoke"),d({result:null,error:c}))}};try{n=JSON.stringify(c),f=this._getUrl("InvokeMethod"),e.performAjaxCall(f,n,!0,function(a){g(JSON.parse(a));h.isBusy=!1},function(a){g({result:null,error:a});h.isBusy=!1},null)}catch(l){a.global._checkIsDummy(l)&&a.global._throwDummy(l),this.isBusy=!1,this._onDataOperError(l,"invoke"),d({result:null,error:l}),a.global._throwDummy(l)}};d.prototype._loadFromCache=function(b,c){var d=b._dbSet,e;try{e=d._fillFromCache({isPageChanged:c,fn_beforeFillEnd:null})}catch(h){a.global._checkIsDummy(h)&&
a.global._throwDummy(h),this._onDataOperError(h,"load"),a.global._throwDummy(h)}return e};d.prototype._loadIncluded=function(a){var b=this;a.included&&0<a.included.length&&a.included.forEach(function(a){b.getDbSet(a.dbSetName).fillItems(a)})};d.prototype._onLoaded=function(b,c){var d=this,h,n,f;try{if(!b)throw Error(e.format(a.ERRS.ERR_UNEXPECTED_SVC_ERROR,"null result"));h=b.dbSetName;n=d.getDbSet(h);if(!n)throw Error(e.format(a.ERRS.ERR_DBSET_NAME_INVALID,h));q(b.error,"load");f=n._fillFromService({res:b,
isPageChanged:c,fn_beforeFillEnd:function(){d._loadIncluded(b)}})}catch(g){a.global._checkIsDummy(g)&&a.global._throwDummy(g),this._onDataOperError(g,"load"),a.global._throwDummy(g)}return f};d.prototype._dataSaved=function(b){var c=this,d=[],h=[];try{try{q(b.error,g)}catch(n){throw b.dbSets.forEach(function(b){var p=c._dbSets[b.dbSetName];b.rows.forEach(function(b){var c=p.getItemByKey(b.clientKey);if(!c)throw Error(e.format(a.ERRS.ERR_KEY_IS_NOTFOUND,b.clientKey));d.push(c);b.invalid&&(p._setItemInvalid(b),
h.push(c))})}),new B(n,d,h);}b.dbSets.forEach(function(a){c._dbSets[a.dbSetName]._commitChanges(a.rows)})}catch(f){a.global._checkIsDummy(f)&&a.global._throwDummy(f),this._onSubmitError(f),a.global._throwDummy(f)}};d.prototype._getChanges=function(){var a={dbSets:[],error:null,trackAssocs:[]};this._arrDbSets.forEach(function(b){b.endEdit();var c=b._getChanges();if(0!==c.length){var d=b._getTrackAssocInfo();a.dbSets.push({dbSetName:b.dbSetName,rows:c});a.trackAssocs=a.trackAssocs.concat(d)}});return a};
d.prototype._getUrl=function(a){var b=this.service_url;e.str.endsWith(b,"/")||(b+="/");return b+=[a,""].join("/")};d.prototype._onItemRefreshed=function(b,c){try{if(q(b.error,"refresh"),b.rowInfo)c._refreshValues(b.rowInfo,2);else throw c._dbSet.removeItem(c),c.destroy(),Error(a.ERRS.ERR_ITEM_DELETED_BY_ANOTHER_USER);}catch(d){a.global._checkIsDummy(d)&&a.global._throwDummy(d),this._onDataOperError(d,"refresh"),a.global._throwDummy(d)}};d.prototype._refreshItem=function(a){var b=e.createDeferred(),
c=function(c){c?b.resolve(a):b.reject()},d=this._getUrl("RefreshItem"),h=a._dbSet,n=this;this.waitForNotSubmiting(function(){h.waitForNotLoading(function(){var b,f=function(){n.isBusy=!1;h.isLoading=!1;a._isRefreshing=!1},g=function(a){f();n._onDataOperError(a,"refresh")};a._isRefreshing=!0;n.isBusy=!0;h.isLoading=!0;try{var l={dbSetName:a._dbSetName,rowInfo:a._getRowInfo(),error:null};a._checkCanRefresh();b=JSON.stringify(l);e.performAjaxCall(d,b,!0,function(b){try{var d=JSON.parse(b);n._onItemRefreshed(d,
a);f();c(!0)}catch(h){g(h),c(!1)}},function(a){f();n._onDataOperError(a,"refresh");c(!1)},null)}catch(s){g(s),c(!1)}},[],!0,null)},[],null);return b.promise()};d.prototype._onError=function(b,d){var h=c.prototype._onError.call(this,b,d);return!h?a.global._onError(b,d):h};d.prototype._onDataOperError=function(b,c){if(a.global._checkIsDummy(b))return!0;var d;d=b instanceof w?b:new w(b,c);return this._onError(d,this)};d.prototype._onSubmitError=function(a){var b={error:a,isHandled:!1};this.raiseEvent("submit_error",
b);b.isHandled||(this.rejectChanges(),this._onDataOperError(a,g))};d.prototype._beforeLoad=function(a,b,c){a&&b!==a&&(c._query=a,c.pageIndex=0);b&&b!==a&&b.destroy();if(a.pageSize!==c.pageSize){c._ignorePageChanged=!0;try{c.pageIndex=0,c.pageSize=a.pageSize}finally{c._ignorePageChanged=!1}}if(a.pageIndex!==c.pageIndex){c._ignorePageChanged=!0;try{c.pageIndex=a.pageIndex}finally{c._ignorePageChanged=!1}}a.isCacheValid||a._clearCache()};d.prototype._load=function(b,c){if(!b)throw Error(a.ERRS.ERR_DB_LOAD_NO_QUERY);
var d=this,h=e.createDeferred(),n=b.loadPageCount,f=b.pageIndex,g=b.isPagingEnabled,l=b.dbSetName,s=this.getDbSet(l);this.waitForNotSubmiting(function(){s.waitForNotLoading(function(){var k=s.query,y=d._getUrl("GetItems"),m,v,q=function(){s.isLoading=!1;d.isBusy=!1},x=function(a){q();h.resolve(a)},w=function(a){q();d._onDataOperError(a,"load");h.reject()},r,z,D=1;s.isLoading=!0;d.isBusy=!0;try{b.pageIndex=f;d._beforeLoad(b,k,s);if(1<n&&g){if(b._isPageCached(f)){r=d._loadFromCache(b,c);x(r);return}z=
b._getCache().getNextRange(f);f=z.start;D=z.cnt}m={dbSetName:l,pageIndex:f,pageSize:b.pageSize,pageCount:D,isIncludeTotalCount:b.isIncludeTotalCount,filterInfo:b.filterInfo,sortInfo:b.sortInfo,paramInfo:d._getMethodParams(b._queryInfo,b.params).paramInfo,queryName:b.queryName};v=JSON.stringify(m);e.performAjaxCall(y,v,!0,function(b){var p=[],h;try{h=b.indexOf(a.MOD.consts.CHUNK_SEP),-1<h?(p.push(b.substr(0,h)),p.push(b.substr(h+a.MOD.consts.CHUNK_SEP.length))):p.push(b),p=p.map(function(a){return JSON.parse(a)}),
setTimeout(function(){var b,h=p[0],n=!!h.included&&0<h.included.length;try{if(1<p.length&&(b=p[1])&&0<b.length)if(n&&h.included.forEach(function(c){c.rows=b.splice(0,c.rowCount);if(c.rowCount!=c.rows.length)throw Error(e.format(a.ERRS.ERR_ASSERTION_FAILED,"subset.rowCount == subset.rows.length"));}),h.rows=b,h.rowCount!=h.rows.length)throw Error(e.format(a.ERRS.ERR_ASSERTION_FAILED,"getDataResult.rowCount == getDataResult.rows.length"));r=d._onLoaded(h,c);x(r)}catch(f){w(f)}},0)}catch(n){w(n)}},function(a){q();
d._onDataOperError(a,"load");h.reject()},null)}catch(t){w(t)}},[],!0,c?"paging":null)},[],c?"paging":null);return h.promise()};d.prototype.getDbSet=function(b){var c=this._dbSets[b];if(!c)throw Error(e.format(a.ERRS.ERR_DBSET_NAME_INVALID,b));return c};d.prototype.getAssociation=function(b){var c=this._assoc["get"+b];if(!c)throw Error(e.format(a.ERRS.ERR_ASSOC_NAME_INVALID,b));return c()};d.prototype.submitChanges=function(){if(this._pendingSubmit)return this._pendingSubmit.deferred.promise();var a=
this,b={deferred:e.createDeferred()},c=function(a){a?b.deferred.resolve():b.deferred.reject()};this._pendingSubmit=b;this.waitForNotBusy(function(){var b,d,h=g,n,f=function(){a.isBusy=!1;a.isSubmiting=!1},l=function(b){f();a._onDataOperError(b,h);c(!1)};try{if(a.isBusy=!0,a.isSubmiting=!0,a._pendingSubmit=null,b=a._getUrl("SaveChanges"),n=a._getChanges(),0===n.dbSets.length){f();c(!0);return}}catch(s){l(s);return}try{d=JSON.stringify(n),e.performAjaxCall(b,d,!0,function(b){try{a._dataSaved(JSON.parse(b)),
f(),c(!0)}catch(d){l(d)}},function(b){f();a._onSubmitError(b);c(!1)},null)}catch(k){l(k)}},[]);return b.deferred.promise()};d.prototype.load=function(a){return this._load(a,!1)};d.prototype.acceptChanges=function(){this._arrDbSets.forEach(function(a){a.acceptChanges()})};d.prototype.rejectChanges=function(){this._arrDbSets.forEach(function(a){a.rejectChanges()})};d.prototype.initialize=function(b){if(!this._isInitialized){var c=this;b=e.extend(!1,{serviceUrl:null,permissions:null},b);this._serviceUrl=
b.serviceUrl;this._initDbSets();if(b.permissions)c._updatePermissions(b.permissions),c._isInitialized=!0,c.raisePropertyChanged("isInitialized");else{b=this._getUrl("GetPermissions");try{this.isBusy=!0,e.performAjaxCall(b,void 0,!0,function(b){try{c._updatePermissions(JSON.parse(b)),c.isBusy=!1,c._isInitialized=!0,c.raisePropertyChanged("isInitialized")}catch(d){c.isBusy=!1,c._onDataOperError(d,"initDbContext"),a.global._throwDummy(d)}},function(a){c.isBusy=!1;c._onDataOperError(a,"initDbContext")},
null)}catch(d){this.isBusy=!1,this._onDataOperError(d,"initDbContext"),a.global._throwDummy(d)}}}};d.prototype.waitForNotBusy=function(a,b){this._waitQueue.enQueue({prop:"isBusy",groupName:null,predicate:function(a){return!a},action:a,actionArgs:b})};d.prototype.waitForNotSubmiting=function(a,b,c){this._waitQueue.enQueue({prop:"isSubmiting",predicate:function(a){return!a},action:a,actionArgs:b,groupName:c,lastWins:!!c})};d.prototype.waitForInitialized=function(a,b){this._waitQueue.enQueue({prop:"isInitialized",
groupName:"dbContext",predicate:function(a){return!!a},action:a,actionArgs:b})};d.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._waitQueue.destroy(),this._waitQueue=null,this._arrAssoc.forEach(function(a){a.destroy()}),this._arrAssoc=[],this._assoc={},this._arrDbSets.forEach(function(a){a.destroy()}),this._arrDbSets=[],this._dbSets={},this._svcMethods={},this._queryInf={},this._serviceUrl=null,this._isInitialized=!1,this._isBusy=0,this._hasChanges=this._isSubmiting=
...
enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"isSubmiting",{get:function(){return this._isSubmiting},set:function(a){this._isSubmiting!==a&&(this._isSubmiting=a,this.raisePropertyChanged("isSubmiting"))},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"serverTimezone",{get:function(){return this._serverTimezone},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"dbSets",{get:function(){return this._dbSets},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,
"arrDbSets",{get:function(){return this._arrDbSets},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"serviceMethods",{get:function(){return this._svcMethods},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"hasChanges",{get:function(){return this._hasChanges},enumerable:!0,configurable:!0});return d}(a.BaseObject);k.DbContext=v;var n=function(b){function h(a){b.call(this);var c=this;this._objId="ass"+e.getNewID();a=e.extend(!1,{dbContext:null,parentName:"",childName:"",
parentKeyFields:[],childKeyFields:[],parentToChildrenName:null,childToParentName:null,name:this._objId,onDeleteAction:x.NoAction},a);this._name=a.name;this._dbContext=a.dbContext;this._onDeleteAction=a.onDeleteAction;this._parentDS=a.dbContext.dbSets[a.parentName];this._childDS=a.dbContext.dbSets[a.childName];this._parentFldInfos=a.parentKeyFields.map(function(a){return c._parentDS.getFieldInfo(a)});this._childFldInfos=a.childKeyFields.map(function(a){return c._childDS.getFieldInfo(a)});this._parentToChildrenName=
a.parentToChildrenName;this._childToParentName=a.childToParentName;this._parentMap={};this._childMap={};this._isChildFilling=this._isParentFilling=!1;this._bindParentDS();a=this._mapParentItems(this._parentDS.items);this._bindChildDS();var d=this._mapChildren(this._childDS.items);this._changedTimeout=this._saveChildFKey=this._saveParentFKey=null;this._changed={};c._notifyParentChanged(a);c._notifyChildrenChanged(d)}__extends(h,b);h.prototype._onError=function(c,d){var h=b.prototype._onError.call(this,
c,d);return!h?a.global._onError(c,d):h};h.prototype._bindParentDS=function(){var a=this,b=this._parentDS;b&&(b._addHandler("coll_changed",function(c,d){b===c&&a._onParentCollChanged(d)},a._objId,!0),b._addHandler("fill",function(c,d){b===c&&a._onParentFill(d)},a._objId,!0),b._addHandler("begin_edit",function(c,d){b===c&&a._onParentEdit(d.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(c,d){b===c&&a._onParentEdit(d.item,!1,d.isCanceled)},a._objId,!0),b._addHandler("item_deleting",function(a,
b){},a._objId,!0),b._addHandler("status_changed",function(c,d){b===c&&a._onParentStatusChanged(d.item,d.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(c,d){b===c&&a._onParentCommitChanges(d.item,d.isBegin,d.isRejected,d.changeType)},a._objId,!0))};h.prototype._bindChildDS=function(){var a=this,b=this._childDS;b&&(b._addHandler("coll_changed",function(c,d){b===c&&a._onChildCollChanged(d)},a._objId,!0),b._addHandler("fill",function(c,d){b===c&&a._onChildFill(d)},a._objId,!0),b._addHandler("begin_edit",
function(c,d){b===c&&a._onChildEdit(d.item,!0,void 0)},a._objId,!0),b._addHandler("end_edit",function(c,d){b===c&&a._onChildEdit(d.item,!1,d.isCanceled)},a._objId,!0),b._addHandler("status_changed",function(c,d){b===c&&a._onChildStatusChanged(d.item,d.oldChangeType)},a._objId,!0),b._addHandler("commit_changes",function(c,d){b===c&&a._onChildCommitChanges(d.item,d.isBegin,d.isRejected,d.changeType)},a._objId,!0))};h.prototype._onParentCollChanged=function(b){var c=this,h;h=b.items;var n=[],f={};switch(b.change_type){case d.RESET:c._isParentFilling||
(n=c.refreshParentMap());break;case d.ADDED:this._isParentFilling||(n=c._mapParentItems(h));break;case d.REMOVE:h.forEach(function(a){(a=c._unMapParentItem(a))&&(f[a]=null)});n=Object.keys(f);break;case d.REMAP_KEY:if(b.old_key&&(h=this._parentMap[b.old_key]))delete this._parentMap[b.old_key],n=this._mapParentItems([h]);break;default:throw Error(e.format(a.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,b.change_type));}c._notifyParentChanged(n)};h.prototype._onParentFill=function(a){a.isBegin?this._isParentFilling=
!0:(this._isParentFilling=!1,a=a.resetUI?this.refreshParentMap():this._mapParentItems(a.newItems),this._notifyParentChanged(a))};h.prototype._onParentEdit=function(a,b,c){b?this._storeParentFKey(a):c?this._saveParentFKey=null:this._checkParentFKey(a)};h.prototype._onParentCommitChanges=function(a,b,d,h){b?d&&h===c.ADDED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):!d&&h===c.DELETED?(a=this._unMapParentItem(a))&&this._notifyParentChanged([a]):this._storeParentFKey(a):this._checkParentFKey(a)};
h.prototype._storeParentFKey=function(a){a=this.getParentFKey(a);null!==a&&this._parentMap[a]&&(this._saveParentFKey=a)};h.prototype._checkParentFKey=function(a){var b,c=this._saveParentFKey;this._saveParentFKey=null;b=this.getParentFKey(a);b!==c&&(c&&(delete this._parentMap[c],this._notifyChildrenChanged([c]),this._notifyParentChanged([c])),b&&(this._mapParentItems([a]),this._notifyChildrenChanged([b]),this._notifyParentChanged([b])))};h.prototype._onParentStatusChanged=function(a,b){var d=this,
h,e,n=x;if(a._changeType===c.DELETED){e=d.getChildItems(a);h=this._unMapParentItem(a);switch(d.onDeleteAction){case n.Cascade:e.forEach(function(a){a.deleteItem()});break;case n.SetNulls:e.forEach(function(a){var b=a.isEditing;b||a.beginEdit();try{d._childFldInfos.forEach(function(b){a[b.fieldName]=null}),b||a.endEdit()}finally{b||a.cancelEdit()}})}h&&d._notifyParentChanged([h])}};h.prototype._onChildCollChanged=function(b){var c=this,h=b.items,n=[],f={};switch(b.change_type){case d.RESET:c._isChildFilling||
(n=c.refreshChildMap());break;case d.ADDED:this._isChildFilling||(n=c._mapChildren(h));break;case d.REMOVE:h.forEach(function(a){(a=c._unMapChildItem(a))&&(f[a]=null)});n=Object.keys(f);break;case d.REMAP_KEY:if(b.old_key&&(b=h[0])){if(n=b._getFieldVal(this._childToParentName))delete this._childMap[n],b._clearFieldVal(this._childToParentName);n=this._mapChildren([b])}break;default:throw Error(e.format(a.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,b.change_type));}c._notifyChildrenChanged(n)};h.prototype._notifyChildrenChanged=
function(a){this._notifyChanged([],a)};h.prototype._notifyParentChanged=function(a){this._notifyChanged(a,[])};h.prototype._notifyChanged=function(a,b){var c=this;if(0<a.length||0<b.length)a.forEach(function(a){var b=c._changed[a];c._changed[a]=b?b|1:1}),b.forEach(function(a){var b=c._changed[a];c._changed[a]=b?b|2:2}),this._changedTimeout||(this._changedTimeout=setTimeout(function(){if(!c._isDestroyCalled){c._changedTimeout=null;var a=c._changed;c._changed={};Object.keys(a).forEach(function(b){var d=
a[b];1==(d&1)&&c._onParentChanged(b);2==(d&2)&&c._onChildrenChanged(b)})}},50))};h.prototype._onChildFill=function(a){a.isBegin?this._isChildFilling=!0:(this._isChildFilling=!1,a=a.resetUI?this.refreshChildMap():this._mapChildren(a.newItems),this._notifyChildrenChanged(a))};h.prototype._onChildEdit=function(a,b,c){b?this._storeChildFKey(a):c?this._saveChildFKey=null:this._checkChildFKey(a)};h.prototype._onChildCommitChanges=function(a,b,d,h){b?d&&h===c.ADDED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):
!d&&h===c.DELETED?(a=this._unMapChildItem(a))&&this._notifyChildrenChanged([a]):this._storeChildFKey(a):this._checkChildFKey(a)};h.prototype._storeChildFKey=function(a){var b=this.getChildFKey(a),c;if(b&&(c=this._childMap[b])&&-1<c.indexOf(a))this._saveChildFKey=b};h.prototype._checkChildFKey=function(a){var b=this._saveChildFKey,c,d;this._saveChildFKey=null;c=this.getChildFKey(a);c!==b&&(b&&(d=this._childMap[b],e.removeFromArray(d,a),0==d.length&&delete this._childMap[b],this._notifyParentChanged([b]),
this._notifyChildrenChanged([b])),c&&(this._mapChildren([a]),this._notifyParentChanged([c]),this._notifyChildrenChanged([c])))};h.prototype._onChildStatusChanged=function(a,b){var d=c.DELETED,h=a._changeType,e=this.getChildFKey(a);e&&h===d&&(e=this._unMapChildItem(a))&&this._notifyChildrenChanged([e])};h.prototype._getItemKey=function(a,b,c){for(var d=[],h,e=0,n=a.length;e<n;e+=1){h=c[a[e].fieldName];h=b._getStrValue(h,a[e]);if(null===h)return null;d.push(h)}return d.join(";")};h.prototype._resetChildMap=
function(){var a=Object.keys(this._childMap);this._childMap={};this._notifyChildrenChanged(a)};h.prototype._resetParentMap=function(){var a=Object.keys(this._parentMap);this._parentMap={};this._notifyParentChanged(a)};h.prototype._unMapChildItem=function(a){var b,c,d=null;if(b=this.getChildFKey(a))if(c=this._childMap[b])a=e.removeFromArray(c,a),-1<a&&(0==c.length&&delete this._childMap[b],d=b);return d};h.prototype._unMapParentItem=function(a){var b=null;if((a=this.getParentFKey(a))&&this._parentMap[a])delete this._parentMap[a],
b=a;return b};h.prototype._mapParentItems=function(a){for(var b,d,h=c.DELETED,e,n={},f=0,g=a.length;f<g;f+=1)if(b=a[f],d=b._changeType,d!==h&&(d=this.getParentFKey(b)))e=this._parentMap[d],e!==b&&(this._parentMap[d]=b,n[d]=null);return Object.keys(n)};h.prototype._onChildrenChanged=function(a){a&&this._parentToChildrenName&&(a=this._parentMap[a])&&a.raisePropertyChanged(this._parentToChildrenName)};h.prototype._onParentChanged=function(a){var b=this;a&&this._childToParentName&&(a=this._childMap[a])&&
a.forEach(function(a){a.raisePropertyChanged(b._childToParentName)})};h.prototype._mapChildren=function(a){for(var b,d,h,e=c.DELETED,n={},f=0,g=a.length;f<g;f+=1)if(b=a[f],d=b._changeType,d!==e&&(d=this.getChildFKey(b)))h=this._childMap[d],h||(h=[],this._childMap[d]=h),0>h.indexOf(b)&&(h.push(b),n[d]||(n[d]=null));return Object.keys(n)};h.prototype._unbindParentDS=function(){var a=this.parentDS;a&&a.removeNSHandlers(this._objId)};h.prototype._unbindChildDS=function(){var a=this.childDS;a&&a.removeNSHandlers(this._objId)};
h.prototype.getParentFKey=function(a){return a&&a._isNew?a._key:this._getItemKey(this._parentFldInfos,this._parentDS,a)};h.prototype.getChildFKey=function(a){if(a&&this._childToParentName){var b=a._getFieldVal(this._childToParentName);if(b)return b}return this._getItemKey(this._childFldInfos,this._childDS,a)};h.prototype.getChildItems=function(a){if(!a)return[];a=this.getParentFKey(a);a=this._childMap[a];return!a?[]:a};h.prototype.getParentItem=function(a){if(!a)return null;a=this.getChildFKey(a);
return(a=this._parentMap[a])?a:null};h.prototype.refreshParentMap=function(){this._resetParentMap();return this._mapParentItems(this._parentDS.items)};h.prototype.refreshChildMap=function(){this._resetChildMap();return this._mapChildren(this._childDS.items)};h.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,clearTimeout(this._changedTimeout),this._changedTimeout=null,this._changed={},this._unbindParentDS(),this._unbindChildDS(),this._childFldInfos=this._parentFldInfos=this._childMap=
this._parentMap=null,b.prototype.destroy.call(this))};h.prototype.toString=function(){return this._name};Object.defineProperty(h.prototype,"name",{get:function(){return this._name},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"parentToChildrenName",{get:function(){return this._parentToChildrenName},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"childToParentName",{get:function(){return this._childToParentName},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,
"parentDS",{get:function(){return this._parentDS},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"childDS",{get:function(){return this._childDS},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"parentFldInfos",{get:function(){return this._parentFldInfos},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"childFldInfos",{get:function(){return this._childFldInfos},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"onDeleteAction",
{get:function(){return this._onDeleteAction},enumerable:!0,configurable:!0});return h}(a.BaseObject);k.Association=n;v=function(b){function c(d){b.call(this);d=e.extend(!1,{dataSource:null,fn_filter:null,fn_sort:null,fn_itemsProvider:null},d);if(!d.dataSource||!e.check.isProtoOf(r.collection.Collection,d.dataSource))throw Error(a.ERRS.ERR_DATAVIEW_DATASRC_INVALID);if(!d.fn_filter||!e.check.isFunction(d.fn_filter))throw Error(a.ERRS.ERR_DATAVIEW_FILTER_INVALID);this._objId="dvw"+e.getNewID();this._dataSource=
d.dataSource;this._fn_filter=d.fn_filter;this._fn_sort=d.fn_sort;this._fn_itemsProvider=d.fn_itemsProvider;this._isAddingNew=this._isDSFilling=!1;var h=this,n=this._dataSource;n.getFieldNames().forEach(function(a){h._fieldMap[a]=e.extend(!1,{},n.getFieldInfo(a))});this._bindDS()}__extends(c,b);c.prototype._getEventNames=function(){var a=b.prototype._getEventNames.call(this);return["view_refreshed"].concat(a)};c.prototype.addOnViewRefreshed=function(a,b){this.addHandler("view_refreshed",a,b)};c.prototype.removeOnViewRefreshed=
function(a){this.removeHandler("view_refreshed",a)};c.prototype._filterForPaging=function(a){var b=0,c=0,d=-1,h=-1,e=[],b=this.pageSize*this.pageIndex,c=this.pageSize;a.forEach(function(a){h+=1;h<b||(d+=1,d<c&&e.push(a))});return e};c.prototype._onViewRefreshed=function(a){this.raiseEvent("view_refreshed",a)};c.prototype._refresh=function(a){var b;if(b=this._dataSource)b=this._fn_itemsProvider?this._fn_itemsProvider(b):b.items,this._fn_filter&&(b=b.filter(this._fn_filter)),this._fn_sort&&(b=b.sort(this._fn_sort)),
this._fillItems({items:b,isPageChanged:!!a,clear:!0,isAppend:!1}),this._onViewRefreshed({})};c.prototype._fillItems=function(a){a=e.extend(!1,{items:[],isPageChanged:!1,clear:!0,isAppend:!1},a);var b=this,c,h=[],n=[],f=[];this._onFillStart({isBegin:!0,rowCount:a.items.length,time:new Date,isPageChanged:a.isPageChanged});try{a.clear&&this.clear(),c=this.isPagingEnabled&&!a.isAppend?this._filterForPaging(a.items):a.items,c.forEach(function(a){var c=b._itemsByKey[a._key];c?f.push(c):(b._itemsByKey[a._key]=
a,h.push(a),n.push(b._items.length-1),b._items.push(a),f.push(a))}),0<h.length&&(this._onItemsChanged({change_type:d.ADDED,items:h,pos:n}),this.raisePropertyChanged("count"))}finally{this._onFillEnd({isBegin:!1,rowCount:f.length,time:new Date,resetUI:!!a.clear,fetchedItems:f,newItems:h,isPageChanged:a.isPageChanged})}this.totalCount=a.clear?a.items.length:this.totalCount+h.length;this.moveFirst();return h};c.prototype._onDSCollectionChanged=function(b){var c=this,h;h=b.items;switch(b.change_type){case d.RESET:this._isDSFilling||
this._refresh(!1);break;case d.ADDED:!this._isAddingNew&&!this._isDSFilling&&(c._fn_filter&&(h=h.filter(c._fn_filter)),c.appendItems(h));break;case d.REMOVE:h.forEach(function(a){(a=c._itemsByKey[a._key])&&c.removeItem(a)});break;case d.REMAP_KEY:if(h=c._itemsByKey[b.old_key])delete c._itemsByKey[b.old_key],c._itemsByKey[b.new_key]=h,this._onItemsChanged(b);break;default:throw Error(e.format(a.ERRS.ERR_COLLECTION_CHANGETYPE_INVALID,b.change_type));}};c.prototype._onDSFill=function(a){var b=a.fetchedItems;
a.isBegin?this._isDSFilling=!0:(this._isDSFilling=!1,a.resetUI?this._refresh(!1):(this._fn_filter&&(b=b.filter(this._fn_filter)),this.appendItems(b)))};c.prototype._onDSStatusChanged=function(a){var b=a.item,c=a.oldChangeType,d=!!this._fn_filter;this._itemsByKey[a.key]?(this._onItemStatusChanged(b,c),d&&((a=this._fn_filter(b))||this.removeItem(b))):d&&(a=this._fn_filter(b))&&this.appendItems([b])};c.prototype._bindDS=function(){var a=this,b=this._dataSource;b&&(b.addHandler("coll_changed",function(c,
d){b===c&&a._onDSCollectionChanged(d)},a._objId),b.addHandler("fill",function(c,d){b===c&&a._onDSFill(d)},a._objId),b.addHandler("begin_edit",function(c,d){b===c&&a._itemsByKey[d.item._key]&&a._onEditing(d.item,!0,!1)},a._objId),b.addHandler("end_edit",function(c,d){if(b===c){var h,e=d.item;h=!!a._fn_filter;a._itemsByKey[e._key]?(a._onEditing(e,!1,d.isCanceled),!d.isCanceled&&h&&((h=a._fn_filter(e))||a.removeItem(e))):!d.isCanceled&&h&&(h=a._fn_filter(e))&&a.appendItems([e])}},a._objId),b.addHandler("errors_changed",
function(c,d){b===c&&a._itemsByKey[d.item._key]&&a._onErrorsChanged(d.item)},a._objId),b.addHandler("status_changed",function(c,d){b===c&&a._onDSStatusChanged(d)},a._objId),b.addHandler("item_deleting",function(c,d){b===c&&a._itemsByKey[d.item._key]&&a._onItemDeleting(d)},a._objId),b.addHandler("item_added",function(c,d){b===c&&a._isAddingNew&&(a._itemsByKey[d.item._key]||a._attach(d.item),a.currentItem=d.item,a._onEditing(d.item,!0,!1),a._onItemAdded(d.item))},a._objId),b.addHandler("item_adding",
function(c,d){b===c&&a._isAddingNew&&a._onItemAdding(d.item)},a._objId))};c.prototype._unbindDS=function(){var a=this._dataSource;a&&a.removeNSHandlers(this._objId)};c.prototype.appendItems=function(a){return this._isDestroyCalled?[]:this._fillItems({items:a,isPageChanged:!1,clear:!1,isAppend:!0})};c.prototype._getStrValue=function(a,b){return this._dataSource._getStrValue(a,b)};c.prototype._onCurrentChanging=function(b){var c=this._dataSource;try{c._EditingItem&&b!==c._EditingItem&&c.endEdit()}catch(d){c.cancelEdit(),
a.global.reThrow(d,this._onError(d,this))}};c.prototype._getErrors=function(a){return this._dataSource._getErrors(a)};c.prototype._onPageChanged=function(){this._refresh(!0)};c.prototype.getItemsWithErrors=function(){return this._dataSource.getItemsWithErrors()};c.prototype.addNew=function(){var a=this._dataSource,b;this._isAddingNew=!0;try{b=a.addNew()}finally{this._isAddingNew=!1}return b};c.prototype.removeItem=function(b){if(null===b._key)throw Error(a.ERRS.ERR_ITEM_IS_DETACHED);if(this._itemsByKey[b._key]){var c=
e.removeFromArray(this._items,b);if(0>c)throw Error(a.ERRS.ERR_ITEM_IS_NOTFOUND);delete this._itemsByKey[b._key];delete this._errors[b._key];this.totalCount-=1;this._onRemoved(b,c);b=this.getItemByPos(c);var d=this._currentPos;d===c&&(b||(this._currentPos=d-1),this._onCurrentChanged());d>c&&(this._currentPos=d-1,this._onCurrentChanged())}};c.prototype.sortLocal=function(b,c){var d=1,h=a.global.parser;c&&"DESC"===c.toUpperCase()&&(d=-1);this.fn_sort=function(a,c){var e=0,n,f,g;n=0;for(f=b.length;n<
f&&!(g=b[n],e=h.resolvePath(a,g),g=h.resolvePath(c,g),e=e<g?-1*d:e>g?d:0,0!==e);n+=1);return e}};c.prototype.getIsHasErrors=function(){return this._dataSource.getIsHasErrors()};c.prototype.clear=function(){this.cancelEdit();this._EditingItem=null;this._newKey=0;this.currentItem=null;this._items=[];this._itemsByKey={};this._errors={};this._onItemsChanged({change_type:d.RESET,items:[]});this.pageIndex=0;this.raisePropertyChanged("count")};c.prototype.refresh=function(){this._refresh(!1)};c.prototype.destroy=
...
set:function(a){this._fn_itemsProvider!==a&&(this._fn_itemsProvider=a,this._refresh(!1))},enumerable:!0,configurable:!0});return c}(r.collection.Collection);k.DataView=v;v=function(a){function b(c){this._refreshTimeout=this._parentItem=null;this._association=c.association;var d=e.extend(!1,{dataSource:this._association.childDS,fn_filter:null,fn_sort:null,fn_itemsProvider:null},c),h=this,n=this._association,f=c.fn_filter;d.fn_filter=function(a){if(!h._parentItem)return!1;var b=n.getParentFKey(h._parentItem);
if(!b)return!1;var c=n.getChildFKey(a);return!c||b!==c?!1:f?f(a):!0};a.call(this,d)}__extends(b,a);b.prototype._refresh=function(){var a=this;this._dataSource&&(clearTimeout(a._refreshTimeout),a._refreshTimeout=setTimeout(function(){if(!a._isDestroyCalled){var b=a._association.getChildItems(a._parentItem);a._fn_filter&&(b=b.filter(a._fn_filter));a._fn_sort&&(b=b.sort(a._fn_sort));a._fillItems({items:b,isPageChanged:!1,clear:!0,isAppend:!1});a._onViewRefreshed({})}},250))};b.prototype.destroy=function(){this._isDestroyed||
(this._isDestroyCalled=!0,clearTimeout(this._refreshTimeout),this._association=null,a.prototype.destroy.call(this))};b.prototype.toString=function(){return this._association?"ChildDataView for "+this._association.toString():"ChildDataView"};Object.defineProperty(b.prototype,"parentItem",{get:function(){return this._parentItem},set:function(a){this._parentItem!==a&&(this._parentItem=a,this.raisePropertyChanged("parentItem"),0<this.items.length&&(this.clear(),this._onViewRefreshed({})),this._refresh())},
enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"association",{get:function(){return this._association},enumerable:!0,configurable:!0});return b}(v);k.ChildDataView=v;a.global.onModuleLoaded("db",k)})(r.db||(r.db={}))})(a.MOD||(a.MOD={}))})(RIAPP||(RIAPP={}));
...
(function(a){(function(r){(function(k){var g=a.global.utils;k.DIALOG_ACTION={Default:0,StayOpen:1};var q=function(e){function f(a,b){e.call(this);var d=this;this._app=a;this._objId="dlg"+g.getNewID();var c=g.extend(!1,{dataContext:null,templateID:null,width:500,height:350,title:"data edit dialog",submitOnOK:!1,canRefresh:!1,canCancel:!0,fn_OnClose:null,fn_OnOK:null,fn_OnShow:null,fn_OnCancel:null,fn_OnTemplateCreated:null},b);this._dataContext=c.dataContext;this._templateID=c.templateID;this._submitOnOK=
c.submitOnOK;this._canRefresh=c.canRefresh;this._canCancel=c.canCancel;this._fn_OnClose=c.fn_OnClose;this._fn_OnOK=c.fn_OnOK;this._fn_OnShow=c.fn_OnShow;this._fn_OnCancel=c.fn_OnCancel;this._fn_OnTemplateCreated=c.fn_OnTemplateCreated;this._isEditable=!1;this._currentSelectable=this._result=this._$template=this._template=null;this._fn_submitOnOK=function(){return!d._dataContext._isCanSubmit?g.createDeferred().resolve().promise():d._dataContext.submitChanges()};this._updateIsEditable();this._options=
{width:c.width,height:c.height,title:c.title,autoOpen:!1,modal:!0,close:function(a,b){d._onClose()},buttons:d._getButtons()};this._dialogCreated=!1;this._createDialog()}__extends(f,e);f.prototype.addOnClose=function(a,b){this.addHandler("close",a,b)};f.prototype.removeOnClose=function(a){this.removeHandler("close",a)};f.prototype.addOnRefresh=function(a,b){this.addHandler("refresh",a,b)};f.prototype.removeOnRefresh=function(a){this.removeHandler("refresh",a)};f.prototype._updateIsEditable=function(){this._isEditable=
g.check.isEditable(this._dataContext)};f.prototype._createDialog=function(){this._dialogCreated||(this._template=this._createTemplate(this._dataContext),this._$template=a.global.$(this._template.el),a.global.document.body.appendChild(this._template.el),this._$template.dialog(this._options),this._dialogCreated=!0,this._fn_OnTemplateCreated&&this._fn_OnTemplateCreated(this._template))};f.prototype._getEventNames=function(){var a=e.prototype._getEventNames.call(this);return["close","refresh"].concat(a)};
f.prototype._createTemplate=function(a){var b=new r.template.Template(this._app,this._templateID);b.isDisabled=!0;b.dataContext=a;return b};f.prototype._getButtons=function(){var e=this,b=[{id:e._objId+"Refresh",text:a.localizable.TEXT.txtRefresh,"class":"btn btn-info",click:function(){e._onRefresh()}},{id:e._objId+"Ok",text:a.localizable.TEXT.txtOk,"class":"btn btn-info",click:function(){e._onOk()}},{id:e._objId+"Cancel",text:a.localizable.TEXT.txtCancel,"class":"btn btn-info",click:function(){e._onCancel()}}];
this.canRefresh||b.shift();this.canCancel||b.pop();return b};f.prototype._getOkButton=function(){return $("#"+this._objId+"Ok")};f.prototype._getCancelButton=function(){return $("#"+this._objId+"Cancel")};f.prototype._getRefreshButton=function(){return $("#"+this._objId+"Refresh")};f.prototype._getAllButtons=function(){return[this._getOkButton(),this._getCancelButton(),this._getRefreshButton()]};f.prototype._disableButtons=function(a){this._getAllButtons().forEach(function(b){b.prop("disabled",!!a)})};
f.prototype._onOk=function(){var e=this,b;b=k.DIALOG_ACTION.Default;this._fn_OnOK&&(b=this._fn_OnOK(this));if(b!=k.DIALOG_ACTION.StayOpen)if(this._dataContext){if(b=this._isEditable?this._dataContext.endEdit():!0)if(this._submitOnOK){this._disableButtons(!0);var d=this.title;this.title=a.localizable.TEXT.txtSubmitting;b=this._fn_submitOnOK();b.always(function(){e._disableButtons(!1);e.title=d});b.done(function(){e._result="ok";e.hide()});b.fail(function(){e._isEditable&&e._dataContext.beginEdit()})}else e._result=
"ok",e.hide()}else e.hide()};f.prototype._onCancel=function(){var a=k.DIALOG_ACTION.Default;this._fn_OnCancel&&(a=this._fn_OnCancel(this));a!=k.DIALOG_ACTION.StayOpen&&(this._result="cancel",this.hide())};f.prototype._onRefresh=function(){var a={isHandled:!1};this.raiseEvent("refresh",a);a.isHandled||this._dataContext&&g.check.isFunction(this._dataContext.refresh)&&this._dataContext.refresh()};f.prototype._onClose=function(){try{"ok"!=this._result&&this._dataContext&&(this._isEditable&&this._dataContext.cancelEdit(),
this._submitOnOK&&g.check.isFunction(this._dataContext.rejectChanges)&&this._dataContext.rejectChanges()),this._fn_OnClose&&this._fn_OnClose(this),this.raiseEvent("close",{})}finally{this._template.isDisabled=!0}var e=this._currentSelectable;this._currentSelectable=null;setTimeout(function(){a.global.currentSelectable=e;e=null},50)};f.prototype._onShow=function(){this._currentSelectable=a.global.currentSelectable;this._fn_OnShow&&this._fn_OnShow(this)};f.prototype.show=function(){this._result=null;
this._$template.dialog("option","buttons",this._getButtons());this._template.isDisabled=!1;this._onShow();this._$template.dialog("open")};f.prototype.hide=function(){this._$template.dialog("close")};f.prototype.getOption=function(a){return this._$template.dialog("option",a)};f.prototype.setOption=function(a,b){this._$template.dialog("option",a,b)};f.prototype.destroy=function(){this._isDestroyed||(this._isDestroyCalled=!0,this._dialogCreated&&(this.hide(),this._$template.remove(),this._template.destroy(),
this._template=this._$template=null,this._dialogCreated=!1),this._app=this._fn_submitOnOK=this._dataContext=null,e.prototype.destroy.call(this))};Object.defineProperty(f.prototype,"dataContext",{get:function(){return this._dataContext},set:function(a){a!==this._dataContext&&(this._dataContext=a,this._template&&(this._template.dataContext=this._dataContext),this._updateIsEditable(),this.raisePropertyChanged("dataContext"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"result",
{get:function(){return this._result},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"template",{get:function(){return this._template},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"isSubmitOnOK",{get:function(){return this._submitOnOK},set:function(a){this._submitOnOK!==a&&(this._submitOnOK=a,this.raisePropertyChanged("isSubmitOnOK"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"width",{get:function(){return this.getOption("width")},set:function(a){var b=
this.getOption("width");a!==b&&(this.setOption("width",a),this.raisePropertyChanged("width"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"height",{get:function(){return this.getOption("height")},set:function(a){var b=this.getOption("height");a!==b&&(this.setOption("height",a),this.raisePropertyChanged("height"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"title",{get:function(){return this.getOption("title")},set:function(a){var b=this.getOption("title");
a!==b&&(this.setOption("title",a),this.raisePropertyChanged("title"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"canRefresh",{get:function(){return this._canRefresh},set:function(a){a!==this._canRefresh&&(this._canRefresh=a,this.raisePropertyChanged("canRefresh"))},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"canCancel",{get:function(){return this._canCancel},set:function(a){a!==this._canCancel&&(this._canCancel=a,this.raisePropertyChanged("canCancel"))},
enumerable:!0,configurable:!0});return f}(a.BaseObject);k.DataEditDialog=q;a.global.onModuleLoaded("datadialog",k)})(r.datadialog||(r.datadialog={}))})(a.MOD||(a.MOD={}))})(RIAPP||(RIAPP={}));
...
!1,a.global.$(this._el).addClass(k.css.rowDeleted)):a.global.$(this._el).removeClass(k.css.rowDeleted))},enumerable:!0,configurable:!0});Object.defineProperty(h.prototype,"isEditing",{get:function(){return!!this._item&&this._item._isEditing},enumerable:!0,configurable:!0});return h}(a.BaseObject);k.Row=x;var w=function(b){function c(d,e){b.call(this);this._grid=d;this._el=e.tr;this._parentRow=this._cell=this._item=null;this._objId="drow"+g.getNewID();this._createCell(e.details_id);this._$el=a.global.$(this._el);
...
configurable:!0});return b}(f);k.DataColumn=z;var m=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype._init=function(){a.prototype._init.call(this);this.$div.addClass(k.css.rowExpander)};b.prototype.toString=function(){return"ExpanderColumn"};return b}(f);k.ExpanderColumn=m;var t=function(b){function c(){b.apply(this,arguments)}__extends(c,b);c.prototype._init=function(){b.prototype._init.call(this);var c=this;this._val=!1;this.$div.addClass(k.css.rowSelector);var d=a.global.$('<input type="checkbox"/>');
...
if(l.fieldName&&!l.fieldInfo){if(!e)throw Error(a.ERRS.ERR_DCTX_HAS_NO_FIELDINFO);l.fieldInfo=b.getFieldInfo(l.fieldName);if(!l.fieldInfo)throw Error(g.format(a.ERRS.ERR_DBSET_INVALID_FIELDNAME,"",l.fieldName));}var w=d.app._getContentType(l);(f=d.app._getContent(w,l,f,b,k))&&d._content.push(f)}});this._lfTime=d.app._bindElements(this._el,b,!0);this._contentCreated=!0}};d.prototype._getParentDataForm=function(b){if(!b)return null;b=b.parentElement;var d;if(b){if(b===this._el)return this._el;d=b.getAttribute(q.DATA_ATTR.DATA_VIEW);
